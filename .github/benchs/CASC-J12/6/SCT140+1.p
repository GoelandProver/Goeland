...
fof(fact_rel__comp__distrib2,axiom,
    ! [V_R_2,V_T_2,V_S_2,T_b,T_c,T_a] : hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)),c_Relation_Orel__comp(T_a,T_c,T_b,V_S_2,V_R_2)),c_Relation_Orel__comp(T_a,T_c,T_b,V_T_2,V_R_2)) = c_Relation_Orel__comp(T_a,T_c,T_b,hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_c),tc_HOL_Obool)),V_S_2),V_T_2),V_R_2) ).
...
fof(fact_rtranclp__reflcl,axiom,
    ! [V_R_2,T_a] : c_Transitive__Closure_Ortranclp(T_a,V_R_2) = c_Transitive__Closure_Ortranclp(T_a,hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_fun(T_a,tc_HOL_Obool))),V_R_2),c_fequal)) ).
...
fof(fact_sup__eq__bot__iff,axiom,
    ! [V_y_2,V_x_2,T_a] :
     ...
     => ( ( V_x_2 = c_Orderings_Obot__class_Obot(T_a)
          & c_Orderings_Obot__class_Obot(T_a) = V_y_2 )
...
fof(fact_rel__comp__empty2,axiom,
    ! [V_R_2,T_b,T_c,T_a] : c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)) = c_Relation_Orel__comp(T_a,T_c,T_b,V_R_2,c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_c,T_b),tc_HOL_Obool))) ).
...
fof(fact_rtrancl__reflcl,axiom,
    ! [V_R_2,T_a] : c_Transitive__Closure_Ortrancl(T_a,V_R_2) = c_Transitive__Closure_Ortrancl(T_a,hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)),V_R_2),c_Relation_OId(T_a))) ).
...
fof(fact_rel__compE,axiom,
    ! [V_s_2,V_r_2,T_c,V_xz_2,T_b,T_a] :
      ( ~ ! [B_x,B_y,B_z] :
            ( hAPP(hAPP(c_Product__Type_OPair(T_a,T_b),B_x),B_z) = V_xz_2
...
fof(fact_rel__comp__empty1,axiom,
    ! [V_R_2,T_b,T_c,T_a] : c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)) = c_Relation_Orel__comp(T_a,T_c,T_b,c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_c),tc_HOL_Obool)),V_R_2) ).
...
fof(fact_IdE,axiom,
    ! [V_p_2,T_a] :
      ( ~ ! [B_x] : hAPP(hAPP(c_Product__Type_OPair(T_a,T_a),B_x),B_x) != V_p_2
