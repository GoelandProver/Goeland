    ...
    ! [V_s_2,V_r_2,T_a] :
     ...
     => ( c_Wellfounded_Owf(T_a,V_s_2)
       => ( c_Wellfounded_Owf(T_a,hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)),V_r_2),V_s_2))
         <= c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)) = hAPP(hAPP(c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool)),c_Relation_ODomain(T_a,T_a,V_r_2)),c_Relation_ORange(T_a,T_a,V_s_2)) ) ) ) ).
...
fof(fact_Nitpick_Owfrec_H__def,axiom,
    ! [V_x_2,V_Fa_2,T_b,V_R_2,T_a] :
      ...
      & ( ~ c_Wellfounded_Owf(T_a,V_R_2)
       => c_HOL_OThe(T_b,c_Recdef_Owfrec__rel(T_a,T_b,V_R_2,hAPP(hAPP(c_COMBC(tc_fun(T_a,T_b),tc_fun(T_a,T_a),tc_fun(T_a,T_b)),hAPP(c_COMBB(tc_fun(T_a,tc_fun(T_a,T_b)),tc_fun(tc_fun(T_a,T_a),tc_fun(T_a,T_b)),tc_fun(T_a,T_b),c_COMBS(T_a,T_a,T_b)),hAPP(c_COMBB(tc_fun(T_a,tc_fun(T_a,T_b)),tc_fun(T_a,tc_fun(T_a,T_b)),tc_fun(T_a,T_b),c_COMBB(tc_fun(T_a,T_b),tc_fun(T_a,T_b),T_a,V_Fa_2)),hAPP(hAPP(c_COMBC(tc_fun(T_a,T_b),tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool),tc_fun(T_a,tc_fun(T_a,T_b))),c_Recdef_Ocut(T_a,T_b)),V_R_2)))),c_COMBI(T_a)),V_x_2)) = c_Nitpick_Owfrec_H(T_a,T_b,V_R_2,V_Fa_2,V_x_2) ) ) ).
