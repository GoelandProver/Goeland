...
fof(fact_reflcl__trancl,axiom,
    ! [V_r_2,T_a] : c_Transitive__Closure_Ortrancl(T_a,V_r_2) = hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)),c_Transitive__Closure_Otrancl(T_a,V_r_2)),c_Relation_OId(T_a)) ).
...
fof(fact_sup__absorb2,axiom,
    ! [V_y,V_x,T_a] :
     ...
     => ( c_Orderings_Oord__class_Oless__eq(T_a,V_x,V_y)
       => V_y = hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(T_a),V_x),V_y) ) ) ).
...
fof(fact_Pair__eq,axiom,
    ! [V_b_H_2,V_a_H_2,V_ba_2,V_aa_2,T_b,T_a] :
      ( ( V_a_H_2 = V_aa_2
        & V_b_H_2 = V_ba_2 )
    <=> hAPP(hAPP(c_Product__Type_OPair(T_a,T_b),V_a_H_2),V_b_H_2) = hAPP(hAPP(c_Product__Type_OPair(T_a,T_b),V_aa_2),V_ba_2) ) ).
