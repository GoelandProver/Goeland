...
fof(fact_Times__empty,axiom,
    ...
    <=> c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)) = c_Product__Type_OSigma(T_a,T_b,V_A_2,c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,V_B_2)) ) ).
...
fof(fact_Id__onE,axiom,
    ! [V_A_2,V_ca_2,T_a] :
      ( ~ ! [B_x] :
            ( hAPP(hAPP(c_Product__Type_OPair(T_a,T_a),B_x),B_x) != V_ca_2
           <= hBOOL(hAPP(hAPP(c_member(T_a),B_x),V_A_2)) )
...
fof(fact_Sigma__Diff__distrib1,axiom,
    ! [V_C_2,V_J_2,V_I_2,T_b,T_a] : hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)),c_Product__Type_OSigma(T_a,T_b,V_I_2,V_C_2)),c_Product__Type_OSigma(T_a,T_b,V_J_2,V_C_2)) = c_Product__Type_OSigma(T_a,T_b,hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_I_2),V_J_2),V_C_2) ).
...
fof(fact_SigmaE,axiom,
    ! [V_B_2,V_A_2,V_ca_2,T_b,T_a] :
     ...
     => ~ ! [B_x] :
            ( hBOOL(hAPP(hAPP(c_member(T_a),B_x),V_A_2))
           => ! [B_y] :
                ( hAPP(hAPP(c_Product__Type_OPair(T_a,T_b),B_x),B_y) != V_ca_2
...
fof(fact_inf__sup__absorb,axiom,
    ! [V_y,V_x,T_a] :
      ( class_Lattices_Olattice(T_a)
     => V_x = hAPP(hAPP(c_Lattices_Osemilattice__inf__class_Oinf(T_a),V_x),hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(T_a),V_x),V_y)) ) ).
...
fof(fact_insert__Diff1,axiom,
    ! [V_A_2,V_B_2,V_x_2,T_a] :
      ( hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),V_B_2) = hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),c_Set_Oinsert(T_a,V_x_2,V_A_2)),V_B_2)
     <= hBOOL(hAPP(hAPP(c_member(T_a),V_x_2),V_B_2)) ) ).
...
fof(fact_Field__def,axiom,
    ! [V_r_2,T_a] : hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool)),c_Relation_ODomain(T_a,T_a,V_r_2)),c_Relation_ORange(T_a,T_a,V_r_2)) = c_Relation_OField(T_a,V_r_2) ).
...
fof(fact_rtrancl__reflcl__absorb,axiom,
    ! [V_R_2,T_a] : c_Transitive__Closure_Ortrancl(T_a,V_R_2) = hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)),c_Transitive__Closure_Ortrancl(T_a,V_R_2)),c_Relation_OId(T_a)) ).
...
fof(fact_Times__Diff__distrib1,axiom,
    ! [V_C_2,V_B_2,V_A_2,T_b,T_a] : hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)),c_Product__Type_OSigma(T_a,T_b,V_A_2,c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,V_C_2))),c_Product__Type_OSigma(T_a,T_b,V_B_2,c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,V_C_2))) = c_Product__Type_OSigma(T_a,T_b,hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),V_B_2),c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,V_C_2)) ).
...
fof(fact_insert__Diff__single,axiom,
    ! [V_A_2,V_aa_2,T_a] : c_Set_Oinsert(T_a,V_aa_2,V_A_2) = c_Set_Oinsert(T_a,V_aa_2,hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),c_Set_Oinsert(T_a,V_aa_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool))))) ).
...
fof(fact_Diff__disjoint,axiom,
    ! [V_B_2,V_A_2,T_a] : c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)) = hAPP(hAPP(c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool)),V_A_2),hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_B_2),V_A_2)) ).
...
fof(fact_Diff__insert2,axiom,
    ! [V_B_2,V_aa_2,V_A_2,T_a] : hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),c_Set_Oinsert(T_a,V_aa_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool))))),V_B_2) = hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),c_Set_Oinsert(T_a,V_aa_2,V_B_2)) ).
...
fof(fact_Diff__cancel,axiom,
    ! [V_A_2,T_a] : c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)) = hAPP(hAPP(c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool)),V_A_2),V_A_2) ).
...
fof(fact_sup__bot__left,axiom,
    ! [V_x,T_a] :
      ( V_x = hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(T_a),c_Orderings_Obot__class_Obot(T_a)),V_x)
     <= class_Lattices_Obounded__lattice__bot(T_a) ) ).
...
fof(fact_curry__def,axiom,
    ! [V_y_2,V_x_2,V_ca_2,T_a,T_c,T_b] : hAPP(V_ca_2,hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_x_2),V_y_2)) = c_Product__Type_Ocurry(T_b,T_c,T_a,V_ca_2,V_x_2,V_y_2) ).
...
fof(fact_sup__absorb1,axiom,
    ! [V_x,V_y,T_a] :
      ( class_Lattices_Osemilattice__sup(T_a)
     => ( c_Orderings_Oord__class_Oless__eq(T_a,V_y,V_x)
       => V_x = hAPP(hAPP(c_Lattices_Osemilattice__sup__class_Osup(T_a),V_x),V_y) ) ) ).
