...
fof(fact_Range__Id,axiom,
    ! [T_a] : c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)) = c_Relation_ORange(T_a,T_a,c_Relation_OId(T_a)) ).
...
fof(fact_inf__top__left,axiom,
    ! [V_x,T_a] :
      ( V_x = c_Lattices_Osemilattice__inf__class_Oinf(T_a,c_Orderings_Otop__class_Otop(T_a),V_x)
     <= class_Lattices_Obounded__lattice__top(T_a) ) ).
...
fof(fact_Domain__Id,axiom,
    ! [T_a] : c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)) = c_Relation_ODomain(T_a,T_a,c_Relation_OId(T_a)) ).
...
fof(fact_Diff__triv,axiom,
    ! [V_B_2,V_A_2,T_a] :
     ...
     => V_A_2 = c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_B_2) ) ).
...
fof(fact_Diff__insert__absorb,axiom,
    ! [V_A_2,V_x_2,T_a] :
      ( V_A_2 = c_Groups_Ominus__class_Ominus(tc_fun(T_a,tc_HOL_Obool),c_Set_Oinsert(T_a,V_x_2,V_A_2),c_Set_Oinsert(T_a,V_x_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool))))
     <= ~ c_member(T_a,V_x_2,V_A_2) ) ).
