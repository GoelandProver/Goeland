...
fof(aADJOINTu_UNIQUE,axiom,
    ! [Q113333,Q113332,F0,FI_] :
     ...
     <= ( ! [X,Y] : s(real,i(s(fun(cart(real,Q113332),real),i(s(fun(cart(real,Q113332),fun(cart(real,Q113332),real)),dot),s(cart(real,Q113332),X))),s(cart(real,Q113332),i(s(fun(cart(real,Q113333),cart(real,Q113332)),F0),s(cart(real,Q113333),Y))))) = s(real,i(s(fun(cart(real,Q113333),real),i(s(fun(cart(real,Q113333),fun(cart(real,Q113333),real)),dot),s(cart(real,Q113333),i(s(fun(cart(real,Q113332),cart(real,Q113333)),FI_),s(cart(real,Q113332),X))))),s(cart(real,Q113333),Y)))
...
fof(aNORMu_1u_POS,axiom,
    ! [X] :
     ...
     => s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),X))) = s(real,i(s(fun(cart(real,n10),real),vectoru_norm),s(cart(real,n10),X))) ) ).
...
fof(aFSTCARTu_VEC,axiom,
    ! [Q120015,Q120021,N0] : s(cart(real,Q120021),i(s(fun(num,cart(real,Q120021)),vec),s(num,N0))) = s(cart(real,Q120021),i(s(fun(cart(real,finite_sum(Q120021,Q120015)),cart(real,Q120021)),fstcart),s(cart(real,finite_sum(Q120021,Q120015)),i(s(fun(num,cart(real,finite_sum(Q120021,Q120015))),vec),s(num,N0))))) ).
    ...
    ! [N,M,F0,S0] :
     ...
     => ( ! [X,Y] :
      ...
      <=> ! [X] :
           ...
           <= ( p(s(bool,i(s(fun(fun(cart(real,M),bool),bool),i(s(fun(cart(real,M),fun(fun(cart(real,M),bool),bool)),in),s(cart(real,M),X))),s(fun(cart(real,M),bool),S0))))
              & s(cart(real,N),i(s(fun(num,cart(real,N)),vec),s(num,i(s(fun(num,num),numeral),s(num,u_0))))) = s(cart(real,N),i(s(fun(cart(real,M),cart(real,N)),F0),s(cart(real,M),X))) ) ) ) ) ).
...
fof(aINu_IMAGEu_LIFTu_DROPu_conjunct1,axiom,
    ! [X,S0] : s(bool,i(s(fun(fun(cart(real,n10),bool),bool),i(s(fun(cart(real,n10),fun(fun(cart(real,n10),bool),bool)),in),s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,X))))),s(fun(cart(real,n10),bool),S0))) = s(bool,i(s(fun(fun(real,bool),bool),i(s(fun(real,fun(fun(real,bool),bool)),in),s(real,X))),s(fun(real,bool),i(s(fun(fun(cart(real,n10),bool),fun(real,bool)),i(s(fun(fun(cart(real,n10),real),fun(fun(cart(real,n10),bool),fun(real,bool))),image),s(fun(cart(real,n10),real),drop))),s(fun(cart(real,n10),bool),S0))))) ).
...
fof(aLINEARu_ID,axiom,
    ! [Q111683,U_0] :
      ( ! [X] : s(cart(real,Q111683),X) = s(cart(real,Q111683),i(s(fun(cart(real,Q111683),cart(real,Q111683)),U_0),s(cart(real,Q111683),X)))
...
fof(aONORMu_ID,axiom,
    ! [N,U_0] :
     ...
     <= ! [X] : s(cart(real,N),X) = s(cart(real,N),i(s(fun(cart(real,N),cart(real,N)),U_0),s(cart(real,N),X))) ) ).
...
fof(aSUMu_VSUM,axiom,
    ! [Q119844,F0,S0] :
      ( s(real,i(s(fun(cart(real,n10),real),drop),s(cart(real,n10),i(s(fun(fun(Q119844,cart(real,n10)),cart(real,n10)),i(s(fun(fun(Q119844,bool),fun(fun(Q119844,cart(real,n10)),cart(real,n10))),vsum),s(fun(Q119844,bool),S0))),s(fun(Q119844,cart(real,n10)),i(s(fun(fun(Q119844,real),fun(Q119844,cart(real,n10))),i(s(fun(fun(real,cart(real,n10)),fun(fun(Q119844,real),fun(Q119844,cart(real,n10)))),o),s(fun(real,cart(real,n10)),lift))),s(fun(Q119844,real),F0))))))) = s(real,i(s(fun(fun(Q119844,real),real),i(s(fun(fun(Q119844,bool),fun(fun(Q119844,real),real)),sum),s(fun(Q119844,bool),S0))),s(fun(Q119844,real),F0)))
...
fof(aADJOINTu_ADJOINT,axiom,
    ! [M,N,F0] :
      ( p(s(bool,i(s(fun(fun(cart(real,M),cart(real,N)),bool),linear),s(fun(cart(real,M),cart(real,N)),F0))))
     => s(fun(cart(real,M),cart(real,N)),F0) = s(fun(cart(real,M),cart(real,N)),i(s(fun(fun(cart(real,N),cart(real,M)),fun(cart(real,M),cart(real,N))),adjoint),s(fun(cart(real,N),cart(real,M)),i(s(fun(fun(cart(real,M),cart(real,N)),fun(cart(real,N),cart(real,M))),adjoint),s(fun(cart(real,M),cart(real,N)),F0))))) ) ).
...
fof(aDOTu_NORMu_NEG,axiom,
    ! [Q104559,X,Y] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_div),s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_sub),s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_add),s(real,i(s(fun(num,real),i(s(fun(real,fun(num,real)),realu_pow),s(real,i(s(fun(cart(real,Q104559),real),vectoru_norm),s(cart(real,Q104559),X))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))),s(real,i(s(fun(num,real),i(s(fun(real,fun(num,real)),realu_pow),s(real,i(s(fun(cart(real,Q104559),real),vectoru_norm),s(cart(real,Q104559),Y))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))))),s(real,i(s(fun(num,real),i(s(fun(real,fun(num,real)),realu_pow),s(real,i(s(fun(cart(real,Q104559),real),vectoru_norm),s(cart(real,Q104559),i(s(fun(cart(real,Q104559),cart(real,Q104559)),i(s(fun(cart(real,Q104559),fun(cart(real,Q104559),cart(real,Q104559))),vectoru_sub),s(cart(real,Q104559),X))),s(cart(real,Q104559),Y))))))),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))))),s(real,i(s(fun(num,real),realu_ofu_num),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit0),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))))))) = s(real,i(s(fun(cart(real,Q104559),real),i(s(fun(cart(real,Q104559),fun(cart(real,Q104559),real)),dot),s(cart(real,Q104559),X))),s(cart(real,Q104559),Y))) ).
...
fof(aDROPu_LAMBDA,axiom,
    ! [U_0] :
     ...
     <= ! [X,I0] : s(real,i(s(fun(num,real),X),s(num,I0))) = s(real,i(s(fun(num,real),i(s(fun(fun(num,real),fun(num,real)),U_0),s(fun(num,real),X))),s(num,I0))) ) ).
...
fof(aVSUMu_ADDu_NUMSEG,axiom,
    ! [Q107272,U_0] :
      ( ! [F0,G0,M0,N0] : s(cart(real,Q107272),i(s(fun(cart(real,Q107272),cart(real,Q107272)),i(s(fun(cart(real,Q107272),fun(cart(real,Q107272),cart(real,Q107272))),vectoru_add),s(cart(real,Q107272),i(s(fun(fun(num,cart(real,Q107272)),cart(real,Q107272)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,Q107272)),cart(real,Q107272))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,N0))))),s(fun(num,cart(real,Q107272)),F0))))),s(cart(real,Q107272),i(s(fun(fun(num,cart(real,Q107272)),cart(real,Q107272)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,Q107272)),cart(real,Q107272))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,N0))))),s(fun(num,cart(real,Q107272)),G0))))) = s(cart(real,Q107272),i(s(fun(fun(num,cart(real,Q107272)),cart(real,Q107272)),i(s(fun(fun(num,bool),fun(fun(num,cart(real,Q107272)),cart(real,Q107272))),vsum),s(fun(num,bool),i(s(fun(num,fun(num,bool)),i(s(fun(num,fun(num,fun(num,bool))),o_o_),s(num,M0))),s(num,N0))))),s(fun(num,cart(real,Q107272)),i(s(fun(fun(num,cart(real,Q107272)),fun(num,cart(real,Q107272))),i(s(fun(fun(num,cart(real,Q107272)),fun(fun(num,cart(real,Q107272)),fun(num,cart(real,Q107272)))),U_0),s(fun(num,cart(real,Q107272)),F0))),s(fun(num,cart(real,Q107272)),G0)))))
...
fof(aSUBSPACEu_IMPu_NONEMPTY,axiom,
    ! [Q121443,S0] :
      ( s(fun(cart(real,Q121443),bool),empty) != s(fun(cart(real,Q121443),bool),S0)
...
fof(aMATRIXu_EQUALu_ROWS,axiom,
    ! [N,M,A5,B0] :
      ( ! [I0] :
          ( s(cart(real,N),i(s(fun(cart(cart(real,N),M),cart(real,N)),i(s(fun(num,fun(cart(cart(real,N),M),cart(real,N))),row),s(num,I0))),s(cart(cart(real,N),M),B0))) = s(cart(real,N),i(s(fun(cart(cart(real,N),M),cart(real,N)),i(s(fun(num,fun(cart(cart(real,N),M),cart(real,N))),row),s(num,I0))),s(cart(cart(real,N),M),A5)))
         <= ( p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,i(s(fun(num,num),numeral),s(num,i(s(fun(num,num),bit1),s(num,u_0))))))),s(num,I0))))
            & p(s(bool,i(s(fun(num,bool),i(s(fun(num,fun(num,bool)),l_a_),s(num,I0))),s(num,i(s(fun(fun(M,bool),num),dimindex),s(fun(M,bool),univ)))))) ) )
    <=> s(cart(cart(real,N),M),B0) = s(cart(cart(real,N),M),A5) ) ).
...
fof(aDOTu_PASTECART,axiom,
    ! [Q121075,Q121076,X1,X2,Y1,Y2] : s(real,i(s(fun(real,real),i(s(fun(real,fun(real,real)),realu_add),s(real,i(s(fun(cart(real,Q121075),real),i(s(fun(cart(real,Q121075),fun(cart(real,Q121075),real)),dot),s(cart(real,Q121075),X1))),s(cart(real,Q121075),Y1))))),s(real,i(s(fun(cart(real,Q121076),real),i(s(fun(cart(real,Q121076),fun(cart(real,Q121076),real)),dot),s(cart(real,Q121076),X2))),s(cart(real,Q121076),Y2))))) = s(real,i(s(fun(cart(real,finite_sum(Q121075,Q121076)),real),i(s(fun(cart(real,finite_sum(Q121075,Q121076)),fun(cart(real,finite_sum(Q121075,Q121076)),real)),dot),s(cart(real,finite_sum(Q121075,Q121076)),i(s(fun(cart(real,Q121076),cart(real,finite_sum(Q121075,Q121076))),i(s(fun(cart(real,Q121075),fun(cart(real,Q121076),cart(real,finite_sum(Q121075,Q121076)))),pastecart),s(cart(real,Q121075),X1))),s(cart(real,Q121076),X2))))),s(cart(real,finite_sum(Q121075,Q121076)),i(s(fun(cart(real,Q121076),cart(real,finite_sum(Q121075,Q121076))),i(s(fun(cart(real,Q121075),fun(cart(real,Q121076),cart(real,finite_sum(Q121075,Q121076)))),pastecart),s(cart(real,Q121075),Y1))),s(cart(real,Q121076),Y2))))) ).
...
fof(aNORMu_LIFT,axiom,
    ! [X] : s(real,i(s(fun(real,real),realu_abs),s(real,X))) = s(real,i(s(fun(cart(real,n10),real),vectoru_norm),s(cart(real,n10),i(s(fun(real,cart(real,n10)),lift),s(real,X))))) ).
