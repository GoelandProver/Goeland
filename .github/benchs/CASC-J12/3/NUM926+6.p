...
fof(fact_122_mult__Bit0,axiom,
    ! [K,L] : bit0(times_times(int,K,L)) = times_times(int,bit0(K),L) ).
...
fof(fact_410_exp__eq__1,axiom,
    ! [X_2,N_1] :
      ( one_one(nat) = power_power(nat,X_2,N_1)
    <=> ( zero_zero(nat) = N_1
        | X_2 = one_one(nat) ) ) ).
...
fof(fact_68_comm__semiring__1__class_Onormalizing__semiring__rules_I14_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [Lx,Ly,Rx,Ry] : times_times(X_a,Lx,times_times(X_a,Ly,times_times(X_a,Rx,Ry))) = times_times(X_a,times_times(X_a,Lx,Ly),times_times(X_a,Rx,Ry)) ) ).

fof(fact_378_neg__one__power,axiom,
    ! [N] :
      ( number_number_of(int,min) = power_power(int,number_number_of(int,min),N)
      | one_one(int) = power_power(int,number_number_of(int,min),N) ) ).
...
fof(fact_430_add__diff__add,axiom,
    ! [X_a] :
      ( ! [A_1,C,B,D] : plus_plus(X_a,minus_minus(X_a,A_1,B),minus_minus(X_a,C,D)) = minus_minus(X_a,plus_plus(X_a,A_1,C),plus_plus(X_a,B,D))
     <= ab_group_add(X_a) ) ).
...
fof(fact_34_zpower__zadd__distrib,axiom,
    ! [X_1,Y_1,Z] : times_times(int,power_power(int,X_1,Y_1),power_power(int,X_1,Z)) = power_power(int,X_1,plus_plus(nat,Y_1,Z)) ).
...
fof(fact_362_xzgcda__linear__aux1,axiom,
    ! [A_1,R_1,B,M,C,D,N] : minus_minus(int,plus_plus(int,times_times(int,A_1,M),times_times(int,C,N)),times_times(int,R_1,plus_plus(int,times_times(int,B,M),times_times(int,D,N)))) = plus_plus(int,times_times(int,minus_minus(int,A_1,times_times(int,R_1,B)),M),times_times(int,minus_minus(int,C,times_times(int,R_1,D)),N)) ).
...
fof(fact_113_comm__semiring__1__class_Onormalizing__semiring__rules_I30_J,axiom,
    ! [X_a] :
      ( ! [X_1,Y_1,Q] : times_times(X_a,power_power(X_a,X_1,Q),power_power(X_a,Y_1,Q)) = power_power(X_a,times_times(X_a,X_1,Y_1),Q)
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_28_zpower__zpower,axiom,
    ! [X_1,Y_1,Z] : power_power(int,X_1,times_times(nat,Y_1,Z)) = power_power(int,power_power(int,X_1,Y_1),Z) ).
...
fof(fact_253_power2__eq__imp__eq,axiom,
    ! [X_a] :
      ( linordered_semidom(X_a)
     => ! [X_1,Y_1] :
          ( power_power(X_a,Y_1,number_number_of(nat,bit0(bit1(pls)))) = power_power(X_a,X_1,number_number_of(nat,bit0(bit1(pls))))
...
fof(fact_398_nat__power__eq__0__iff,axiom,
    ! [Ma,N_1] :
      ( ( Ma = zero_zero(nat)
        & zero_zero(nat) != N_1 )
    <=> zero_zero(nat) = power_power(nat,Ma,N_1) ) ).
...
fof(fact_387_power__eq__if,axiom,
    ! [P,M] :
      ( ( zero_zero(nat) = M
       => one_one(nat) = power_power(nat,P,M) )
      & ( times_times(nat,P,power_power(nat,P,minus_minus(nat,M,one_one(nat)))) = power_power(nat,P,M)
       <= zero_zero(nat) != M ) ) ).
...
fof(fact_249_zero__power2,axiom,
    ! [X_a] :
      ( semiring_1(X_a)
     => zero_zero(X_a) = power_power(X_a,zero_zero(X_a),number_number_of(nat,bit0(bit1(pls)))) ) ).
...
fof(fact_197_comm__semiring__1__class_Onormalizing__semiring__rules_I10_J,axiom,
    ! [X_a] :
      ( ! [A_1] : zero_zero(X_a) = times_times(X_a,A_1,zero_zero(X_a))
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_10_power2__eq__square__number__of,axiom,
    ! [X_b] :
      ( ( number(X_b)
        & monoid_mult(X_b) )
     => ! [W] : times_times(X_b,number_number_of(X_b,W),number_number_of(X_b,W)) = power_power(X_b,number_number_of(X_b,W),number_number_of(nat,bit0(bit1(pls)))) ) ).

fof(fact_126_Bit0__def,axiom,
    ! [K] : plus_plus(int,K,K) = bit0(K) ).
...
fof(fact_350_diff__bin__simps_I1_J,axiom,
    ! [K] : ti(int,K) = minus_minus(int,K,pls) ).
...
fof(fact_250_zero__eq__power2,axiom,
    ! [X_a] :
      ( ! [A_2] :
          ( zero_zero(X_a) = ti(X_a,A_2)
        <=> zero_zero(X_a) = power_power(X_a,A_2,number_number_of(nat,bit0(bit1(pls)))) )
...
fof(fact_205_zadd__0__right,axiom,
    ! [Z] : ti(int,Z) = plus_plus(int,Z,zero_zero(int)) ).
...
fof(fact_471_mult__eq__0__iff,axiom,
    ! [X_a] :
     ...
     => ! [A_2,B_1] :
          ( zero_zero(X_a) = times_times(X_a,A_2,B_1)
...
fof(fact_139_comm__semiring__1__class_Onormalizing__semiring__rules_I3_J,axiom,
    ! [X_a] :
      ( ! [M,A_1] : times_times(X_a,plus_plus(X_a,A_1,one_one(X_a)),M) = plus_plus(X_a,M,times_times(X_a,A_1,M))
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_259_power__add,axiom,
    ! [X_a] :
      ( monoid_mult(X_a)
     => ! [A_1,M,N] : times_times(X_a,power_power(X_a,A_1,M),power_power(X_a,A_1,N)) = power_power(X_a,A_1,plus_plus(nat,M,N)) ) ).

fof(fact_138_comm__semiring__1__class_Onormalizing__semiring__rules_I2_J,axiom,
    ! [X_a] :
      ( ! [A_1,M] : times_times(X_a,plus_plus(X_a,A_1,one_one(X_a)),M) = plus_plus(X_a,times_times(X_a,A_1,M),M)
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_159_mult__Bit1,axiom,
    ! [K,L] : plus_plus(int,bit0(times_times(int,K,L)),L) = times_times(int,bit1(K),L) ).
...
fof(fact_15_comm__semiring__1__class_Onormalizing__semiring__rules_I36_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [X_1,N] : times_times(X_a,power_power(X_a,X_1,N),power_power(X_a,X_1,N)) = power_power(X_a,X_1,times_times(nat,number_number_of(nat,bit0(bit1(pls))),N)) ) ).
...
fof(tsy_c_Power_Opower__class_Opower_arg1,axiom,
    ! [B_1_1,B_2_1,X_a] :
      ( power(X_a)
     => power_power(X_a,B_1_1,B_2_1) = power_power(X_a,ti(X_a,B_1_1),B_2_1) ) ).
...
fof(fact_101_power__even__eq,axiom,
    ! [X_a] :
      ( monoid_mult(X_a)
     => ! [A_1,N] : power_power(X_a,power_power(X_a,A_1,N),number_number_of(nat,bit0(bit1(pls)))) = power_power(X_a,A_1,times_times(nat,number_number_of(nat,bit0(bit1(pls))),N)) ) ).
...
fof(fact_161_power3__eq__cube,axiom,
    ! [X_a] :
      ( ! [A_1] : times_times(X_a,times_times(X_a,A_1,A_1),A_1) = power_power(X_a,A_1,number_number_of(nat,bit1(bit1(pls))))
     <= monoid_mult(X_a) ) ).
...
fof(fact_9_power2__sum,axiom,
    ! [X_a] :
      ( number_semiring(X_a)
     => ! [X_1,Y_1] : plus_plus(X_a,plus_plus(X_a,power_power(X_a,X_1,number_number_of(nat,bit0(bit1(pls)))),power_power(X_a,Y_1,number_number_of(nat,bit0(bit1(pls))))),times_times(X_a,times_times(X_a,number_number_of(X_a,bit0(bit1(pls))),X_1),Y_1)) = power_power(X_a,plus_plus(X_a,X_1,Y_1),number_number_of(nat,bit0(bit1(pls)))) ) ).
...
fof(tsy_c_Residues_OLegendre_arg1,axiom,
    ! [B_1_1,B_2_1] : legendre(B_1_1,B_2_1) = legendre(ti(int,B_1_1),B_2_1) ).
...
fof(fact_172_real__sum__squared__expand,axiom,
    ! [X_1,Y_1] : plus_plus(real,plus_plus(real,power_power(real,X_1,number_number_of(nat,bit0(bit1(pls)))),power_power(real,Y_1,number_number_of(nat,bit0(bit1(pls))))),times_times(real,times_times(real,number_number_of(real,bit0(bit1(pls))),X_1),Y_1)) = power_power(real,plus_plus(real,X_1,Y_1),number_number_of(nat,bit0(bit1(pls)))) ).
...
fof(tsy_c_Groups_Ominus__class_Ominus_1_res,axiom,
    ! [B_1_1,B_2_1] : minus_minus(nat,B_1_1,B_2_1) = ti(nat,minus_minus(nat,B_1_1,B_2_1)) ).
...
fof(tsy_c_Power_Opower__class_Opower_res,axiom,
    ! [B_1_1,B_2_1,X_a] :
      ( power_power(X_a,B_1_1,B_2_1) = ti(X_a,power_power(X_a,B_1_1,B_2_1))
     <= power(X_a) ) ).
...
fof(fact_109_crossproduct__noteq,axiom,
    ! [X_a] :
     ...
     => ! [C_1,D_1,A_2,B_1] :
        ...
        <=> plus_plus(X_a,times_times(X_a,A_2,D_1),times_times(X_a,B_1,C_1)) != plus_plus(X_a,times_times(X_a,A_2,C_1),times_times(X_a,B_1,D_1)) ) ) ).
...
fof(fact_431_real__mult__left__cancel,axiom,
    ! [A_2,B_1,C_1] :
      ( zero_zero(real) != C_1
     => ( times_times(real,C_1,B_1) = times_times(real,C_1,A_2)
      <=> B_1 = A_2 ) ) ).
...
fof(fact_26_comm__semiring__1__class_Onormalizing__semiring__rules_I31_J,axiom,
    ! [X_a] :
      ( ! [X_1,P,Q] : power_power(X_a,X_1,times_times(nat,P,Q)) = power_power(X_a,power_power(X_a,X_1,P),Q)
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_352_zdiff__zmult__distrib,axiom,
    ! [Z1,Z2,W] : minus_minus(int,times_times(int,Z1,W),times_times(int,Z2,W)) = times_times(int,minus_minus(int,Z1,Z2),W) ).
...
fof(fact_365_Euler_Oaux1,axiom,
    ! [A_1,X_1] :
      ( ( ( ord_less(int,X_1,minus_minus(int,A_1,one_one(int)))
         <= minus_minus(int,A_1,one_one(int)) != ti(int,X_1) )
...
fof(fact_452_realpow__num__eq__if,axiom,
    ! [X_a] :
      ( ! [M,N] :
          ( ( N = zero_zero(nat)
           => one_one(X_a) = power_power(X_a,M,N) )
          & ( times_times(X_a,M,power_power(X_a,M,minus_minus(nat,N,one_one(nat)))) = power_power(X_a,M,N)
           <= N != zero_zero(nat) ) )
     <= power(X_a) ) ).
...
fof(fact_150_add__Bit0__Bit1,axiom,
    ! [K,L] : bit1(plus_plus(int,K,L)) = plus_plus(int,bit0(K),bit1(L)) ).
...
fof(fact_260_power__one,axiom,
    ! [X_a] :
      ( monoid_mult(X_a)
     => ! [N] : one_one(X_a) = power_power(X_a,one_one(X_a),N) ) ).

fof(fact_149_add__Bit1__Bit0,axiom,
    ! [K,L] : bit1(plus_plus(int,K,L)) = plus_plus(int,bit1(K),bit0(L)) ).
...
fof(fact_432_real__mult__right__cancel,axiom,
    ! [A_2,B_1,C_1] :
      ( zero_zero(real) != C_1
     => ( times_times(real,B_1,C_1) = times_times(real,A_2,C_1)
      <=> B_1 = A_2 ) ) ).
...
fof(fact_183_power__eq__0__iff,axiom,
    ! [X_a] :
      ( ( zero_neq_one(X_a)
        ...
        & power(X_a) )
     => ! [A_2,N_1] :
          ( zero_zero(X_a) = power_power(X_a,A_2,N_1)
...
fof(fact_187_power__eq__imp__eq__base,axiom,
    ! [X_a] :
      ( ! [A_1,N,B] :
          ( power_power(X_a,B,N) = power_power(X_a,A_1,N)
         => ( ord_less_eq(X_a,zero_zero(X_a),A_1)
           => ( ( ti(X_a,B) = ti(X_a,A_1)
               <= ord_less(nat,zero_zero(nat),N) )
             <= ord_less_eq(X_a,zero_zero(X_a),B) ) ) )
...
fof(fact_78_comm__semiring__1__class_Onormalizing__semiring__rules_I22_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [A_1,C,D] : plus_plus(X_a,C,plus_plus(X_a,A_1,D)) = plus_plus(X_a,A_1,plus_plus(X_a,C,D)) ) ).
...
fof(fact_107_comm__semiring__1__class_Onormalizing__semiring__rules_I1_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [A_1,M,B] : times_times(X_a,plus_plus(X_a,A_1,B),M) = plus_plus(X_a,times_times(X_a,A_1,M),times_times(X_a,B,M)) ) ).
...
fof(fact_325_nat__number__of__mult__left,axiom,
    ! [V_1,K,V] :
      ( ( times_times(nat,number_number_of(nat,V),times_times(nat,number_number_of(nat,V_1),K)) = times_times(nat,number_number_of(nat,times_times(int,V,V_1)),K)
       <= ~ ord_less(int,V,pls) )
      & ( ord_less(int,V,pls)
       => zero_zero(nat) = times_times(nat,number_number_of(nat,V),times_times(nat,number_number_of(nat,V_1),K)) ) ) ).
...
fof(fact_261_power__mult,axiom,
    ! [X_a] :
      ( monoid_mult(X_a)
     => ! [A_1,M,N] : power_power(X_a,power_power(X_a,A_1,M),N) = power_power(X_a,A_1,times_times(nat,M,N)) ) ).
...
fof(fact_66_comm__semiring__1__class_Onormalizing__semiring__rules_I13_J,axiom,
    ! [X_a] :
      ( ! [Lx,Ly,Rx,Ry] : times_times(X_a,times_times(X_a,Lx,Rx),times_times(X_a,Ly,Ry)) = times_times(X_a,times_times(X_a,Lx,Ly),times_times(X_a,Rx,Ry))
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_257_power__commutes,axiom,
    ! [X_a] :
      ( ! [A_1,N] : times_times(X_a,A_1,power_power(X_a,A_1,N)) = times_times(X_a,power_power(X_a,A_1,N),A_1)
     <= monoid_mult(X_a) ) ).

fof(fact_71_comm__semiring__1__class_Onormalizing__semiring__rules_I18_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [Lx,Rx,Ry] : times_times(X_a,times_times(X_a,Lx,Rx),Ry) = times_times(X_a,Lx,times_times(X_a,Rx,Ry)) ) ).
...
fof(fact_377_zdiff__power3,axiom,
    ! [A_1,B] : minus_minus(int,plus_plus(int,minus_minus(int,power_power(int,A_1,number_number_of(nat,bit1(bit1(pls)))),times_times(int,times_times(int,number_number_of(int,bit1(bit1(pls))),power_power(int,A_1,number_number_of(nat,bit0(bit1(pls))))),B)),times_times(int,times_times(int,number_number_of(int,bit1(bit1(pls))),A_1),power_power(int,B,number_number_of(nat,bit0(bit1(pls)))))),power_power(int,B,number_number_of(nat,bit1(bit1(pls))))) = power_power(int,minus_minus(int,A_1,B),number_number_of(nat,bit1(bit1(pls)))) ).
...
fof(fact_167_semiring__one__add__one__is__two,axiom,
    ! [X_a] :
      ( number_semiring(X_a)
     => number_number_of(X_a,bit0(bit1(pls))) = plus_plus(X_a,one_one(X_a),one_one(X_a)) ) ).
...
fof(fact_393_nat__mult__eq__one,axiom,
    ! [N_1,Ma] :
      ( one_one(nat) = times_times(nat,N_1,Ma)
    <=> ( N_1 = one_one(nat)
        & Ma = one_one(nat) ) ) ).
...
fof(fact_358_diff__bin__simps_I9_J,axiom,
    ! [K,L] : bit1(minus_minus(int,K,L)) = minus_minus(int,bit1(K),bit0(L)) ).
...
fof(fact_339_zcong__iff__lin,axiom,
    ! [A_2,B_1,Ma] :
      ( zcong(A_2,B_1,Ma)
    <=> ? [K_2] : plus_plus(int,A_2,times_times(int,Ma,K_2)) = ti(int,B_1) ) ).
...
fof(fact_17_add__special_I3_J,axiom,
    ! [X_a] :
      ( number_ring(X_a)
     => ! [V] : number_number_of(X_a,plus_plus(int,V,bit1(pls))) = plus_plus(X_a,number_number_of(X_a,V),one_one(X_a)) ) ).
...
fof(fact_434_mult__diff__mult,axiom,
    ! [X_a] :
      ( ring(X_a)
     => ! [X_1,Y_1,A_1,B] : plus_plus(X_a,times_times(X_a,X_1,minus_minus(X_a,Y_1,B)),times_times(X_a,minus_minus(X_a,X_1,A_1),B)) = minus_minus(X_a,times_times(X_a,X_1,Y_1),times_times(X_a,A_1,B)) ) ).
...
fof(tsy_c_Groups_Ozero__class_Ozero_1_res,axiom,
    ! [X_a] :
      ( no_zero_divisors(X_a)
     => zero_zero(X_a) = ti(X_a,zero_zero(X_a)) ) ).
...
fof(fact_357_left__diff__distrib__number__of,axiom,
    ! [X_b] :
      ( ! [A_1,B,V] : minus_minus(X_b,times_times(X_b,A_1,number_number_of(X_b,V)),times_times(X_b,B,number_number_of(X_b,V))) = times_times(X_b,minus_minus(X_b,A_1,B),number_number_of(X_b,V))
     <= ( ring(X_b)
        & number(X_b) ) ) ).
...
fof(fact_110_comm__semiring__1__class_Onormalizing__semiring__rules_I34_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [X_1,Y_1,Z] : plus_plus(X_a,times_times(X_a,X_1,Y_1),times_times(X_a,X_1,Z)) = times_times(X_a,X_1,plus_plus(X_a,Y_1,Z)) ) ).
...
fof(fact_131_zadd__zmult__distrib2,axiom,
    ! [W,Z1,Z2] : plus_plus(int,times_times(int,W,Z1),times_times(int,W,Z2)) = times_times(int,W,plus_plus(int,Z1,Z2)) ).
...
fof(fact_371_mult__sum2sq,axiom,
    ! [A_1,B,P,Q] : twoSqu579703163sum2sq(product_Pair(int,int,plus_plus(int,times_times(int,A_1,P),times_times(int,B,Q)),minus_minus(int,times_times(int,A_1,Q),times_times(int,B,P)))) = times_times(int,twoSqu579703163sum2sq(product_Pair(int,int,A_1,B)),twoSqu579703163sum2sq(product_Pair(int,int,P,Q))) ).

fof(fact_52_add__nat__number__of,axiom,
    ! [V_1,V] :
      ( ( ord_less(int,V,pls)
       => number_number_of(nat,V_1) = plus_plus(nat,number_number_of(nat,V),number_number_of(nat,V_1)) )
      & ( ~ ord_less(int,V,pls)
       => ( ( ~ ord_less(int,V_1,pls)
           => number_number_of(nat,plus_plus(int,V,V_1)) = plus_plus(nat,number_number_of(nat,V),number_number_of(nat,V_1)) )
          & ( ord_less(int,V_1,pls)
...
fof(tsy_c_Groups_Oplus__class_Oplus_0_arg1,axiom,
    ! [B_1_1,B_2_1,X_a] :
      ( semiring(X_a)
     => plus_plus(X_a,B_1_1,B_2_1) = plus_plus(X_a,ti(X_a,B_1_1),B_2_1) ) ).
...
fof(fact_33_comm__semiring__1__class_Onormalizing__semiring__rules_I26_J,axiom,
    ! [X_a] :
      ( comm_semiring_1(X_a)
     => ! [X_1,P,Q] : power_power(X_a,X_1,plus_plus(nat,P,Q)) = times_times(X_a,power_power(X_a,X_1,P),power_power(X_a,X_1,Q)) ) ).
...
fof(fact_12_one__power2,axiom,
    ! [X_a] :
      ( one_one(X_a) = power_power(X_a,one_one(X_a),number_number_of(nat,bit0(bit1(pls))))
     <= semiring_1(X_a) ) ).
...
fof(fact_229_odd__nonzero,axiom,
    ! [Z] : zero_zero(int) != plus_plus(int,plus_plus(int,one_one(int),Z),Z) ).

fof(tsy_c_Groups_Ominus__class_Ominus_0_res,axiom,
    ! [B_1_1,B_2_1,X_a] :
      ( minus_minus(X_a,B_1_1,B_2_1) = ti(X_a,minus_minus(X_a,B_1_1,B_2_1))
     <= ab_group_add(X_a) ) ).
...
fof(tsy_c_TwoSquares__Mirabelle__iprzenvtji_Osum2sq_res,axiom,
    ! [B_1_1] : twoSqu579703163sum2sq(B_1_1) = ti(int,twoSqu579703163sum2sq(B_1_1)) ).
    ...
    ! [X_a] :
     ...
     => ! [V_1,V] :
          ( ( ord_less_eq(int,pls,V_1)
           => number_number_of(X_a,plus_plus(int,V,V_1)) = plus_plus(X_a,number_number_of(X_a,V),number_number_of(X_a,V_1)) )
         <= ord_less_eq(int,pls,V) ) ) ).

fof(fact_315_zmult__eq__1__iff,axiom,
    ! [Ma,N_1] :
      ( times_times(int,Ma,N_1) = one_one(int)
    <=> ( ( number_number_of(int,min) = ti(int,N_1)
...
fof(fact_364_add__number__of__diff1,axiom,
    ! [X_a] :
      ( number_ring(X_a)
     => ! [V,W,C] : minus_minus(X_a,number_number_of(X_a,plus_plus(int,V,W)),C) = plus_plus(X_a,number_number_of(X_a,V),minus_minus(X_a,number_number_of(X_a,W),C)) ) ).
...
fof(fact_420_realpow__two__sum__zero__iff,axiom,
    ! [X_2,Y_2] :
      ( zero_zero(real) = plus_plus(real,power_power(real,X_2,number_number_of(nat,bit0(bit1(pls)))),power_power(real,Y_2,number_number_of(nat,bit0(bit1(pls)))))
    <=> ( zero_zero(real) = X_2
        & Y_2 = zero_zero(real) ) ) ).
...
fof(fact_340_power__0__left__number__of,axiom,
    ! [X_a] :
      ( ! [W] :
          ( ( zero_zero(X_a) = power_power(X_a,zero_zero(X_a),number_number_of(nat,W))
...
fof(fact_77_comm__semiring__1__class_Onormalizing__semiring__rules_I25_J,axiom,
    ! [X_a] :
      ( ! [A_1,C,D] : plus_plus(X_a,plus_plus(X_a,A_1,C),D) = plus_plus(X_a,A_1,plus_plus(X_a,C,D))
     <= comm_semiring_1(X_a) ) ).

fof(fact_309_power__0,axiom,
    ! [X_a] :
      ( power(X_a)
     => ! [A_1] : one_one(X_a) = power_power(X_a,A_1,zero_zero(nat)) ) ).

fof(fact_170_prime__g__5,axiom,
    ! [P] :
      ( ( number_number_of(int,bit0(bit1(pls))) != ti(int,P)
       => ( number_number_of(int,bit1(bit1(pls))) != ti(int,P)
...
fof(fact_433_real__add__mult__distrib,axiom,
    ! [Z1,Z2,W] : plus_plus(real,times_times(real,Z1,W),times_times(real,Z2,W)) = times_times(real,plus_plus(real,Z1,Z2),W) ).
...
fof(fact_415_divides__div__not,axiom,
    ! [X_1,Q,N,R_1] :
      ( plus_plus(nat,times_times(nat,Q,N),R_1) = X_1
...
fof(fact_143_mult__number__of__left,axiom,
    ! [X_a] :
      ( number_ring(X_a)
     => ! [V,W,Z] : times_times(X_a,number_number_of(X_a,times_times(int,V,W)),Z) = times_times(X_a,number_number_of(X_a,V),times_times(X_a,number_number_of(X_a,W),Z)) ) ).
...
fof(fact_133_semiring__mult__number__of,axiom,
    ! [X_a] :
     ...
     => ! [V_1,V] :
          ( ( ord_less_eq(int,pls,V_1)
           => number_number_of(X_a,times_times(int,V,V_1)) = times_times(X_a,number_number_of(X_a,V),number_number_of(X_a,V_1)) )
         <= ord_less_eq(int,pls,V) ) ) ).
...
fof(fact_353_zdiff__zmult__distrib2,axiom,
    ! [W,Z1,Z2] : minus_minus(int,times_times(int,W,Z1),times_times(int,W,Z2)) = times_times(int,W,minus_minus(int,Z1,Z2)) ).

fof(fact_36_nat__mult__2__right,axiom,
    ! [Z] : plus_plus(nat,Z,Z) = times_times(nat,Z,number_number_of(nat,bit0(bit1(pls)))) ).
...
fof(fact_355_number__of__diff,axiom,
    ! [X_a] :
      ( ! [V,W] : minus_minus(X_a,number_number_of(X_a,V),number_number_of(X_a,W)) = number_number_of(X_a,minus_minus(int,V,W))
     <= number_ring(X_a) ) ).
...
fof(conj_0,conjecture,
    ? [X,Y] : plus_plus(int,times_times(int,number_number_of(int,bit0(bit0(bit1(pls)))),m),one_one(int)) = plus_plus(int,power_power(int,X,number_number_of(nat,bit0(bit1(pls)))),power_power(int,Y,number_number_of(nat,bit0(bit1(pls))))) ).
...
fof(fact_73_comm__semiring__1__class_Onormalizing__semiring__rules_I7_J,axiom,
    ! [X_a] :
      ( ! [A_1,B] : times_times(X_a,B,A_1) = times_times(X_a,A_1,B)
     <= comm_semiring_1(X_a) ) ).
...
fof(fact_242_pos__zmult__eq__1__iff,axiom,
    ! [N_1,Ma] :
      ...
      <=> one_one(int) = times_times(int,Ma,N_1) )
...
fof(fact_359_diff__bin__simps_I10_J,axiom,
    ! [K,L] : bit0(minus_minus(int,K,L)) = minus_minus(int,bit1(K),bit1(L)) ).
...
fof(fact_217_add__scale__eq__noteq,axiom,
    ! [X_a] :
      ( ! [C,D,A_1,B,R_1] :
          ( ( ( ti(X_a,D) != ti(X_a,C)
              & ti(X_a,A_1) = ti(X_a,B) )
           => plus_plus(X_a,B,times_times(X_a,R_1,D)) != plus_plus(X_a,A_1,times_times(X_a,R_1,C)) )
