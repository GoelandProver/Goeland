...
fof(fact_quotientE,axiom,
    ! [V_r_2,V_A_2,V_X_2,T_a] :
      ( c_member(tc_fun(T_a,tc_HOL_Obool),V_X_2,c_Equiv__Relations_Oquotient(T_a,V_A_2,V_r_2))
     => ~ ! [B_x] :
            ( c_Relation_OImage(T_a,T_a,V_r_2,c_Set_Oinsert(T_a,B_x,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)))) = V_X_2
           => ~ c_member(T_a,B_x,V_A_2) ) ) ).
...
fof(fact_Int__Un__distrib,axiom,
    ! [V_C_2,V_B_2,V_A_2,T_a] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_B_2),c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_C_2)) = c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),V_A_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_B_2,V_C_2)) ).
...
fof(fact_inf_Ocommute,axiom,
    ! [V_b,V_a,T_a] :
      ( c_Lattices_Osemilattice__inf__class_Oinf(T_a,V_b,V_a) = c_Lattices_Osemilattice__inf__class_Oinf(T_a,V_a,V_b)
     <= class_Lattices_Osemilattice__inf(T_a) ) ).
...
fof(fact_Field__insert,axiom,
    ! [V_r_2,V_ba_2,V_aa_2,T_a] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),c_Set_Oinsert(T_a,V_aa_2,c_Set_Oinsert(T_a,V_ba_2,c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)))),c_Relation_OField(T_a,V_r_2)) = c_Relation_OField(T_a,c_Set_Oinsert(tc_prod(T_a,T_a),c_Product__Type_OPair(T_a,T_a,V_aa_2,V_ba_2),V_r_2)) ).
...
fof(fact_sup__absorb2,axiom,
    ! [V_y,V_x,T_a] :
      ( ( c_Orderings_Oord__class_Oless__eq(T_a,V_x,V_y)
       => V_y = c_Lattices_Osemilattice__sup__class_Osup(T_a,V_x,V_y) )
     <= class_Lattices_Osemilattice__sup(T_a) ) ).
...
fof(fact_Int__empty__left,axiom,
    ! [V_B_2,T_a] : c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)) = c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),c_Orderings_Obot__class_Obot(tc_fun(T_a,tc_HOL_Obool)),V_B_2) ).

fof(fact_Pair__eq,axiom,
    ! [V_b_Ha_2,V_a_Ha_2,V_ba_2,V_aa_2,T_b,T_a] :
      ( ( V_aa_2 = V_a_Ha_2
        & V_ba_2 = V_b_Ha_2 )
    <=> c_Product__Type_OPair(T_a,T_b,V_a_Ha_2,V_b_Ha_2) = c_Product__Type_OPair(T_a,T_b,V_aa_2,V_ba_2) ) ).
