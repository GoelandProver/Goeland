...
fof(fact_rtranclp__r__diff__Id,axiom,
    ! [V_r_2,T_a] : c_Transitive__Closure_Ortranclp(T_a,V_r_2) = c_Transitive__Closure_Ortranclp(T_a,c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_fun(T_a,tc_HOL_Obool)),V_r_2,hAPP(hAPP(c_COMBB(tc_fun(T_a,tc_HOL_Obool),tc_fun(T_a,tc_HOL_Obool),T_a),hAPP(c_COMBB(tc_HOL_Obool,tc_HOL_Obool,T_a),c_fNot)),c_fequal))) ).
...
fof(fact_pair__less__def,axiom,
    c_Wellfounded_Olex__prod(tc_Nat_Onat,tc_Nat_Onat,c_Wellfounded_Oless__than,c_Wellfounded_Oless__than) = c_FunDef_Opair__less ).
