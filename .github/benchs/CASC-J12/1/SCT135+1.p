...
fof(fact_def__wfrec,axiom,
    ! [V_aa_2,V_H_2,V_r_2,T_b,T_a,V_f_2] :
      ( ( hAPP(hAPP(V_H_2,c_Recdef_Ocut(T_a,T_b,V_f_2,V_r_2,V_aa_2)),V_aa_2) = hAPP(V_f_2,V_aa_2)
...
fof(fact_SigmaE,axiom,
    ! [V_B_2,V_A_2,V_c_2,T_b,T_a] :
     ...
     => ~ ! [B_x] :
            ( ! [B_y] :
                ( c_Product__Type_OPair(T_a,T_b,B_x,B_y) != V_c_2
...
fof(fact_Int__UNIV__left,axiom,
    ! [V_B_2,T_a] : V_B_2 = c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool),c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)),V_B_2) ).
