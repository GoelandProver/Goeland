...
fof(fact_UNIV__Times__UNIV,axiom,
    ! [T_b,T_a] : c_Orderings_Otop__class_Otop(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool)) = c_Product__Type_OSigma(T_a,T_b,c_Orderings_Otop__class_Otop(tc_fun(T_a,tc_HOL_Obool)),c_COMBK(tc_fun(T_b,tc_HOL_Obool),T_a,c_Orderings_Otop__class_Otop(tc_fun(T_b,tc_HOL_Obool)))) ).
...
fof(fact_tfl__cut__apply,axiom,
    ! [T_b,V_a_2,V_x_2,T_a,B_f,B_R] :
     ...
     => hAPP(B_f,V_x_2) = hAPP(hAPP(hAPP(hAPP(c_Recdef_Ocut(T_a,T_b),B_f),B_R),V_a_2),V_x_2) ) ).
...
fof(fact_internal__split__conv,axiom,
    ! [V_b_2,V_a_2,V_c_2,T_a,T_c,T_b] : hAPP(hAPP(V_c_2,V_a_2),V_b_2) = hAPP(hAPP(c_Product__Type_Ointernal__split(T_b,T_c,T_a),V_c_2),hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_a_2),V_b_2)) ).
...
fof(fact_prod_Orecs,axiom,
    ! [V_b_2,V_a_2,V_f1_2,T_a,T_c,T_b] : hAPP(hAPP(V_f1_2,V_a_2),V_b_2) = c_Product__Type_Oprod_Oprod__rec(T_b,T_c,T_a,V_f1_2,hAPP(hAPP(c_Product__Type_OPair(T_b,T_c),V_a_2),V_b_2)) ).
...
fof(fact_split__eta,axiom,
    ! [V_f_2,T_c,T_b,T_a] : V_f_2 = hAPP(c_Product__Type_Oprod_Oprod__case(T_a,T_b,T_c),hAPP(hAPP(c_COMBB(tc_fun(T_b,tc_prod(T_a,T_b)),tc_fun(T_b,T_c),T_a),hAPP(c_COMBB(tc_prod(T_a,T_b),T_c,T_b),V_f_2)),c_Product__Type_OPair(T_a,T_b))) ).
...
fof(fact_insert__inter__insert,axiom,
    ! [V_B_2,V_A_2,V_a_2,T_a] : c_Set_Oinsert(T_a,V_a_2,hAPP(hAPP(c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool)),V_A_2),V_B_2)) = hAPP(hAPP(c_Lattices_Osemilattice__inf__class_Oinf(tc_fun(T_a,tc_HOL_Obool)),c_Set_Oinsert(T_a,V_a_2,V_A_2)),c_Set_Oinsert(T_a,V_a_2,V_B_2)) ).
