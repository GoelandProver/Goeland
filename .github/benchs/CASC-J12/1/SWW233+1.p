...
fof(fact_pCons_Oprems,axiom,
    c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(tc_Complex_Ocomplex)) != c_Polynomial_OpCons(tc_Complex_Ocomplex,v_c____,v_cs____) ).
...
fof(fact_poly__rec__pCons,axiom,
    ! [V_pa_2,V_ab_2,T_a,V_za_2,V_f_2,T_b] :
     ...
     => ( hAPP(hAPP(hAPP(V_f_2,V_ab_2),V_pa_2),c_Polynomial_Opoly__rec(T_a,T_b,V_za_2,V_f_2,V_pa_2)) = c_Polynomial_Opoly__rec(T_a,T_b,V_za_2,V_f_2,c_Polynomial_OpCons(T_b,V_ab_2,V_pa_2))
       <= V_za_2 = hAPP(hAPP(hAPP(V_f_2,c_Groups_Ozero__class_Ozero(T_b)),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))),V_za_2) ) ) ).
...
fof(fact_zmod__zdiv__trivial,axiom,
    ! [V_b,V_a] : c_Groups_Ozero__class_Ozero(tc_Int_Oint) = c_Divides_Odiv__class_Odiv(tc_Int_Oint,c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b),V_b) ).
...
fof(fact_expi__add,axiom,
    ! [V_b,V_a] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Complex_Ocomplex),c_Complex_Oexpi(V_a)),c_Complex_Oexpi(V_b)) = c_Complex_Oexpi(c_Groups_Oplus__class_Oplus(tc_Complex_Ocomplex,V_a,V_b)) ).
...
fof(fact_div__mod__equality_H,axiom,
    ! [V_n,V_m] : c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n)) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),c_Divides_Odiv__class_Odiv(tc_Nat_Onat,V_m,V_n)),V_n) ).
    ...
    ! [V_b_2,V_ab_2,V_P_2] :
      ( ~ ( ( c_Orderings_Oord__class_Oless(tc_Nat_Onat,V_ab_2,V_b_2)
          ...
          | ? [B_d] :
              ...
              & c_Groups_Oplus__class_Oplus(tc_Nat_Onat,V_b_2,B_d) = V_ab_2 ) )
...
fof(fact_sgn__0__0,axiom,
    ! [V_ab_2,T_a] :
      ( class_Rings_Olinordered__idom(T_a)
     => ( c_Groups_Ozero__class_Ozero(T_a) = V_ab_2
      <=> c_Groups_Ozero__class_Ozero(T_a) = c_Groups_Osgn__class_Osgn(T_a,V_ab_2) ) ) ).
...
fof(fact_zmod__zdiv__equality,axiom,
    ! [V_b,V_a] : c_Groups_Oplus__class_Oplus(tc_Int_Oint,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Int_Oint),V_b),c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,V_b)),c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b)) = V_a ).
...
fof(fact_zmod__eq__0__iff,axiom,
    ! [V_db_2,V_m_2] :
      ( ? [B_q] : hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Int_Oint),V_db_2),B_q) = V_m_2
...
fof(fact_zabs__less__one__iff,axiom,
    ! [V_za_2] :
      ( c_Groups_Ozero__class_Ozero(tc_Int_Oint) = V_za_2
...
fof(fact_poly__rec__0,axiom,
    ! [T_a,V_za_2,V_f_2,T_b] :
      ( ( hAPP(hAPP(hAPP(V_f_2,c_Groups_Ozero__class_Ozero(T_b)),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))),V_za_2) = V_za_2
       => V_za_2 = c_Polynomial_Opoly__rec(T_a,T_b,V_za_2,V_f_2,c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_b))) )
     <= class_Groups_Ozero(T_b) ) ).
...
fof(fact_mod__pos__neg__trivial,axiom,
    ! [V_b,V_a] :
     ...
     => ( c_Orderings_Oord__class_Oless__eq(tc_Int_Oint,c_Groups_Oplus__class_Oplus(tc_Int_Oint,V_a,V_b),c_Groups_Ozero__class_Ozero(tc_Int_Oint))
       => c_Groups_Oplus__class_Oplus(tc_Int_Oint,V_a,V_b) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b) ) ) ).
...
fof(fact_rcis__zero__mod,axiom,
    ! [V_a] : c_Groups_Ozero__class_Ozero(tc_Complex_Ocomplex) = c_Complex_Orcis(c_Groups_Ozero__class_Ozero(tc_RealDef_Oreal),V_a) ).
...
fof(fact_zdiv__self,axiom,
    ! [V_a] :
     ...
     => c_Groups_Oone__class_Oone(tc_Int_Oint) = c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,V_a) ) ).
...
fof(fact_poly__mod__mult__right,axiom,
    ! [V_z,V_y,V_x,T_a] :
      ( class_Fields_Ofield(T_a)
     => c_Groups_Oplus__class_Oplus(tc_Polynomial_Opoly(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_y),c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),c_Divides_Odiv__class_Odiv(tc_Polynomial_Opoly(T_a),V_x,V_y),V_z)),c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),V_x,V_y)) = c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),V_x,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_y),V_z)) ) ).
...
fof(fact_le__mod__geq,axiom,
    ! [V_m,V_n] :
      ( c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,V_n),V_n) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n)
     <= c_Orderings_Oord__class_Oless__eq(tc_Nat_Onat,V_n,V_m) ) ).
...
fof(fact_add__left__cancel,axiom,
    ! [V_ca_2,V_b_2,V_ab_2,T_a] :
      ( class_Groups_Ocancel__semigroup__add(T_a)
     => ( V_ca_2 = V_b_2
      <=> c_Groups_Oplus__class_Oplus(T_a,V_ab_2,V_ca_2) = c_Groups_Oplus__class_Oplus(T_a,V_ab_2,V_b_2) ) ) ).
...
fof(fact_mod__add__cong,axiom,
    ! [V_b_H,V_b,V_a_H,V_c,V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => ( ( c_Divides_Odiv__class_Omod(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a_H,V_b_H),V_c) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,V_b),V_c)
         <= c_Divides_Odiv__class_Omod(T_a,V_b_H,V_c) = c_Divides_Odiv__class_Omod(T_a,V_b,V_c) )
       <= c_Divides_Odiv__class_Omod(T_a,V_a_H,V_c) = c_Divides_Odiv__class_Omod(T_a,V_a,V_c) ) ) ).
...
fof(fact_pCons__eq__iff,axiom,
    ! [V_q_2,V_b_2,V_pa_2,V_ab_2,T_a] :
     ...
     => ( ( V_ab_2 = V_b_2
          & V_pa_2 = V_q_2 )
      <=> c_Polynomial_OpCons(T_a,V_b_2,V_q_2) = c_Polynomial_OpCons(T_a,V_ab_2,V_pa_2) ) ) ).
...
fof(fact_Nat_Odiff__diff__eq,axiom,
    ! [V_n,V_m,V_k] :
     ...
     => ( c_Orderings_Oord__class_Oless__eq(tc_Nat_Onat,V_k,V_n)
       => c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,V_n) = c_Groups_Ominus__class_Ominus(tc_Nat_Onat,c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_m,V_k),c_Groups_Ominus__class_Ominus(tc_Nat_Onat,V_n,V_k)) ) ) ).
...
fof(fact_mod__mult__self2,axiom,
    ! [V_c,V_b,V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => c_Divides_Odiv__class_Omod(T_a,V_a,V_b) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b),V_c)),V_b) ) ).
...
fof(fact_abs__sgn,axiom,
    ! [V_k,T_a] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_k),c_Groups_Osgn__class_Osgn(T_a,V_k)) = c_Groups_Oabs__class_Oabs(T_a,V_k)
     <= class_Rings_Olinordered__idom(T_a) ) ).
