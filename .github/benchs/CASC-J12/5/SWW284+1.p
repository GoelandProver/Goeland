...
fof(fact_mod__1,axiom,
    ! [V_m] : c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat))) ).
...
fof(fact_mod__mult2__eq,axiom,
    ! [V_c,V_b,V_a] : c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_b),c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Divides_Odiv__class_Odiv(tc_Nat_Onat,V_a,V_b),V_c)),c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_a,V_b)) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_b),V_c)) ).
...
fof(fact_zmod__eq__dvd__iff,axiom,
    ! [V_y_2,V_n_2,V_x_2] :
      ( c_Divides_Odiv__class_Omod(tc_Int_Oint,V_y_2,V_n_2) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_x_2,V_n_2)
...
fof(fact_mod__diff__eq,axiom,
    ! [V_c,V_b,V_a,T_a] :
     ...
     => c_Divides_Odiv__class_Omod(T_a,c_Groups_Ominus__class_Ominus(T_a,c_Divides_Odiv__class_Omod(T_a,V_a,V_c),c_Divides_Odiv__class_Omod(T_a,V_b,V_c)),V_c) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Ominus__class_Ominus(T_a,V_a,V_b),V_c) ) ).
...
fof(fact_mod__mult__self3,axiom,
    ! [V_m,V_n,V_k] : c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_k),V_n),V_m),V_n) ).
...
fof(fact_minus__divide__left,axiom,
    ! [V_b,V_a,T_a] :
     ...
     => c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a),V_b) = c_Groups_Ouminus__class_Ouminus(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b)) ) ).
...
fof(fact_mod__mult__self4,axiom,
    ! [V_m,V_n,V_k] : c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(V_m),V_n) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(c_Groups_Oplus__class_Oplus(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_k),V_n),V_m)),V_n) ).
...
fof(fact_zdiv__zminus2__eq__if,axiom,
    ! [V_a,V_b] :
      ( ( ( c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_b)) = c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,V_b))
         <= c_Groups_Ozero__class_Ozero(tc_Int_Oint) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b) )
        & ( c_Groups_Ominus__class_Ominus(tc_Int_Oint,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,V_b)),c_Groups_Oone__class_Oone(tc_Int_Oint)) = c_Divides_Odiv__class_Odiv(tc_Int_Oint,V_a,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_b))
...
fof(fact_nonzero__inverse__eq__divide,axiom,
    ! [V_a,T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => ( c_Groups_Ozero__class_Ozero(T_a) != V_a
       => c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oone__class_Oone(T_a),V_a) = c_Rings_Oinverse__class_Oinverse(T_a,V_a) ) ) ).
...
fof(fact_coeff__mult__degree__sum,axiom,
    ! [V_q,V_p,T_a] :
      ( class_Rings_Ocomm__semiring__0(T_a)
     => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(c_Polynomial_Ocoeff(T_a,V_p),c_Polynomial_Odegree(T_a,V_p))),hAPP(c_Polynomial_Ocoeff(T_a,V_q),c_Polynomial_Odegree(T_a,V_q))) = hAPP(c_Polynomial_Ocoeff(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Polynomial_Opoly(T_a)),V_p),V_q)),c_Groups_Oplus__class_Oplus(tc_Nat_Onat,c_Polynomial_Odegree(T_a,V_p),c_Polynomial_Odegree(T_a,V_q))) ) ).
...
fof(fact_add__num__frac,axiom,
    ! [V_x,V_z,V_y,T_a] :
      ( ( c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oplus__class_Oplus(T_a,V_x,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_z),V_y)),V_y) = c_Groups_Oplus__class_Oplus(T_a,V_z,c_Rings_Oinverse__class_Odivide(T_a,V_x,V_y))
...
fof(fact_poly__gcd__minus__left,axiom,
    ! [V_y,V_x,T_a] :
      ( class_Fields_Ofield(T_a)
     => c_Polynomial_Opoly__gcd(T_a,V_x,V_y) = c_Polynomial_Opoly__gcd(T_a,c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),V_x),V_y) ) ).
...
fof(fact_inverse__1,axiom,
    ! [T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => c_Groups_Oone__class_Oone(T_a) = c_Rings_Oinverse__class_Oinverse(T_a,c_Groups_Oone__class_Oone(T_a)) ) ).
...
fof(fact_zmod__zminus__zminus,axiom,
    ! [V_b,V_a] : c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b)) = c_Divides_Odiv__class_Omod(tc_Int_Oint,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_a),c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_b)) ).
...
fof(fact_mod__mult__right__eq,axiom,
    ! [V_c,V_b,V_a,T_a] :
      ( c_Divides_Odiv__class_Omod(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),c_Divides_Odiv__class_Omod(T_a,V_b,V_c)),V_c) = c_Divides_Odiv__class_Omod(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b),V_c)
     <= class_Divides_Osemiring__div(T_a) ) ).
...
fof(fact_mod__Suc,axiom,
    ! [V_n,V_m] :
      ( ( V_n = c_Nat_OSuc(c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n))
       => c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(V_m),V_n) )
      & ( c_Nat_OSuc(c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n)) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(V_m),V_n)
...
fof(fact_zmod__eq__0__iff,axiom,
    ...
    <=> c_Groups_Ozero__class_Ozero(tc_Int_Oint) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_m_2,V_d_2) ) ).
...
fof(fact_division__ring__inverse__diff,axiom,
    ! [V_b,V_a,T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => ( ( V_b != c_Groups_Ozero__class_Ozero(T_a)
         => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Rings_Oinverse__class_Oinverse(T_a,V_a)),c_Groups_Ominus__class_Ominus(T_a,V_b,V_a))),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) = c_Groups_Ominus__class_Ominus(T_a,c_Rings_Oinverse__class_Oinverse(T_a,V_a),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) )
       <= V_a != c_Groups_Ozero__class_Ozero(T_a) ) ) ).
...
fof(fact_dvd__div__mult__self,axiom,
    ! [V_b,V_a,T_a] :
      ( ( V_b = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Divides_Odiv__class_Odiv(T_a,V_b,V_a)),V_a)
       <= c_Rings_Odvd__class_Odvd(T_a,V_a,V_b) )
     <= class_Divides_Osemiring__div(T_a) ) ).
    ...
    ! [V_pa_2,T_a] :
     ...
     => ( ~ c_Fundamental__Theorem__Algebra__Mirabelle_Oconstant(T_a,T_a,c_Polynomial_Opoly(T_a,V_pa_2))
       => ? [B_k,B_a] :
            ...
            & c_Groups_Ozero__class_Ozero(tc_Nat_Onat) != B_k
            & ? [B_q] :
                ( c_Fundamental__Theorem__Algebra__Mirabelle_Opsize(T_a,V_pa_2) = c_Groups_Oplus__class_Oplus(tc_Nat_Onat,c_Groups_Oplus__class_Oplus(tc_Nat_Onat,c_Fundamental__Theorem__Algebra__Mirabelle_Opsize(T_a,B_q),B_k),c_Groups_Oone__class_Oone(tc_Nat_Onat))
                & ! [B_z] : c_Groups_Oplus__class_Oplus(T_a,hAPP(c_Polynomial_Opoly(T_a,V_pa_2),c_Groups_Ozero__class_Ozero(T_a)),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),B_z),B_k)),hAPP(c_Polynomial_Opoly(T_a,c_Polynomial_OpCons(T_a,B_a,B_q)),B_z))) = hAPP(c_Polynomial_Opoly(T_a,V_pa_2),B_z) ) ) ) ) ).
...
fof(fact_mod__mult__self2__is__0,axiom,
    ! [V_b,V_a,T_a] :
      ( c_Groups_Ozero__class_Ozero(T_a) = c_Divides_Odiv__class_Omod(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b),V_b)
     <= class_Divides_Osemiring__div(T_a) ) ).
...
fof(fact_dvd__div__eq__mult,axiom,
    ! [V_c_2,V_b_2,V_a_2,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => ( V_a_2 != c_Groups_Ozero__class_Ozero(T_a)
       => ( ( V_c_2 = c_Divides_Odiv__class_Odiv(T_a,V_b_2,V_a_2)
...
fof(fact_div__mult__self1__is__m,axiom,
    ! [V_m,V_n] :
      ( V_m = c_Divides_Odiv__class_Odiv(tc_Nat_Onat,hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_n),V_m),V_n)
     <= c_Orderings_Oord__class_Oless(tc_Nat_Onat,c_Groups_Ozero__class_Ozero(tc_Nat_Onat),V_n) ) ).

fof(fact_smult__minus__right,axiom,
    ! [V_p,V_a,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),c_Polynomial_Osmult(T_a,V_a,V_p)) = c_Polynomial_Osmult(T_a,V_a,c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),V_p))
     <= class_Rings_Ocomm__ring(T_a) ) ).
...
fof(fact_division__ring__inverse__add,axiom,
    ! [V_b,V_a,T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => ( ( c_Groups_Ozero__class_Ozero(T_a) != V_b
         => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Rings_Oinverse__class_Oinverse(T_a,V_a)),c_Groups_Oplus__class_Oplus(T_a,V_a,V_b))),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) = c_Groups_Oplus__class_Oplus(T_a,c_Rings_Oinverse__class_Oinverse(T_a,V_a),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) )
       <= V_a != c_Groups_Ozero__class_Ozero(T_a) ) ) ).
...
fof(fact_inverse__zero__imp__zero,axiom,
    ! [V_a,T_a] :
      ( class_Rings_Odivision__ring(T_a)
     => ( c_Groups_Ozero__class_Ozero(T_a) = c_Rings_Oinverse__class_Oinverse(T_a,V_a)
       => c_Groups_Ozero__class_Ozero(T_a) = V_a ) ) ).
...
fof(fact_smult__pCons,axiom,
    ! [V_p,V_b,V_a,T_a] :
      ( class_Rings_Ocomm__semiring__0(T_a)
     => c_Polynomial_OpCons(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b),c_Polynomial_Osmult(T_a,V_a,V_p)) = c_Polynomial_Osmult(T_a,V_a,c_Polynomial_OpCons(T_a,V_b,V_p)) ) ).
...
fof(fact_nonzero__power__divide,axiom,
    ! [V_n,V_a,V_b,T_a] :
      ( class_Fields_Ofield(T_a)
     => ( c_Rings_Oinverse__class_Odivide(T_a,hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_a),V_n),hAPP(hAPP(c_Power_Opower__class_Opower(T_a),V_b),V_n)) = hAPP(hAPP(c_Power_Opower__class_Opower(T_a),c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b)),V_n)
       <= V_b != c_Groups_Ozero__class_Ozero(T_a) ) ) ).
...
fof(fact_expand__poly__eq,axiom,
    ! [V_qa_2,V_pa_2,T_a] :
      ( ( V_pa_2 = V_qa_2
      <=> ! [B_n] : hAPP(c_Polynomial_Ocoeff(T_a,V_qa_2),B_n) = hAPP(c_Polynomial_Ocoeff(T_a,V_pa_2),B_n) )
     <= class_Groups_Ozero(T_a) ) ).
...
fof(fact_leading__coeff__0__iff,axiom,
    ! [V_pa_2,T_a] :
      ( class_Groups_Ozero(T_a)
     => ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = V_pa_2
      <=> c_Groups_Ozero__class_Ozero(T_a) = hAPP(c_Polynomial_Ocoeff(T_a,V_pa_2),c_Polynomial_Odegree(T_a,V_pa_2)) ) ) ).
...
fof(fact_zmod__zminus1__not__zero,axiom,
    ! [V_l,V_k] :
      ( c_Groups_Ozero__class_Ozero(tc_Int_Oint) != c_Divides_Odiv__class_Omod(tc_Int_Oint,V_k,V_l)
...
fof(fact_right__inverse,axiom,
    ! [V_a,T_a] :
      ( ( c_Groups_Oone__class_Oone(T_a) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),c_Rings_Oinverse__class_Oinverse(T_a,V_a))
       <= V_a != c_Groups_Ozero__class_Ozero(T_a) )
     <= class_Rings_Odivision__ring(T_a) ) ).
...
fof(fact_mod__div__equality,axiom,
    ! [V_b,V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => V_a = c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Divides_Odiv__class_Odiv(T_a,V_a,V_b)),V_b),c_Divides_Odiv__class_Omod(T_a,V_a,V_b)) ) ).
...
fof(fact_poly__div__minus__left,axiom,
    ! [V_y,V_x,T_a] :
      ( c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),c_Divides_Odiv__class_Odiv(tc_Polynomial_Opoly(T_a),V_x,V_y)) = c_Divides_Odiv__class_Odiv(tc_Polynomial_Opoly(T_a),c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),V_x),V_y)
     <= class_Fields_Ofield(T_a) ) ).
...
fof(fact_coeff__linear__power,axiom,
    ! [V_n,V_a,T_a] :
      ( c_Groups_Oone__class_Oone(T_a) = hAPP(c_Polynomial_Ocoeff(T_a,hAPP(hAPP(c_Power_Opower__class_Opower(tc_Polynomial_Opoly(T_a)),c_Polynomial_OpCons(T_a,V_a,c_Polynomial_OpCons(T_a,c_Groups_Oone__class_Oone(T_a),c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a))))),V_n)),V_n)
     <= class_Rings_Ocomm__semiring__1(T_a) ) ).
...
fof(fact_mod__by__1,axiom,
    ! [V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => c_Groups_Ozero__class_Ozero(T_a) = c_Divides_Odiv__class_Omod(T_a,V_a,c_Groups_Oone__class_Oone(T_a)) ) ).
...
fof(fact_eq__add__iff2,axiom,
    ! [V_d_2,V_b_2,V_c_2,V_e_2,V_a_2,T_a] :
      ( class_Rings_Oring(T_a)
     => ( c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b_2),V_e_2),V_d_2) = c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a_2),V_e_2),V_c_2)
      <=> c_Groups_Oplus__class_Oplus(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Ominus__class_Ominus(T_a,V_b_2,V_a_2)),V_e_2),V_d_2) = V_c_2 ) ) ).
...
fof(fact_frac__eq__eq,axiom,
    ! [V_w_2,V_x_2,V_z_2,V_y_2,T_a] :
      ( class_Fields_Ofield(T_a)
     => ( c_Groups_Ozero__class_Ozero(T_a) != V_y_2
       => ( c_Groups_Ozero__class_Ozero(T_a) != V_z_2
...
fof(fact_poly__mod__minus__left,axiom,
    ! [V_y,V_x,T_a] :
      ( class_Fields_Ofield(T_a)
     => c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),V_x,V_y)) = c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),c_Groups_Ouminus__class_Ouminus(tc_Polynomial_Opoly(T_a),V_x),V_y) ) ).
...
fof(fact_inverse__mult__distrib,axiom,
    ! [V_b,V_a,T_a] :
      ( class_Fields_Ofield__inverse__zero(T_a)
     => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Rings_Oinverse__class_Oinverse(T_a,V_a)),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) = c_Rings_Oinverse__class_Oinverse(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b)) ) ).
...
fof(fact_zdiff__zmod__left,axiom,
    ! [V_y,V_m,V_x] : c_Divides_Odiv__class_Omod(tc_Int_Oint,c_Groups_Ominus__class_Ominus(tc_Int_Oint,V_x,V_y),V_m) = c_Divides_Odiv__class_Omod(tc_Int_Oint,c_Groups_Ominus__class_Ominus(tc_Int_Oint,c_Divides_Odiv__class_Omod(tc_Int_Oint,V_x,V_m),V_y),V_m) ).
...
fof(fact_dvd__div__mult,axiom,
    ! [V_c,V_b,V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => ( c_Divides_Odiv__class_Odiv(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_b),V_c),V_a) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Divides_Odiv__class_Odiv(T_a,V_b,V_a)),V_c)
       <= c_Rings_Odvd__class_Odvd(T_a,V_a,V_b) ) ) ).
...
fof(fact_nonzero__inverse__mult__distrib,axiom,
    ! [V_b,V_a,T_a] :
      ( ( c_Groups_Ozero__class_Ozero(T_a) != V_a
       => ( c_Groups_Ozero__class_Ozero(T_a) != V_b
         => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Rings_Oinverse__class_Oinverse(T_a,V_b)),c_Rings_Oinverse__class_Oinverse(T_a,V_a)) = c_Rings_Oinverse__class_Oinverse(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),V_b)) ) )
     <= class_Rings_Odivision__ring(T_a) ) ).
...
fof(fact_inverse__add,axiom,
    ! [V_b,V_a,T_a] :
      ( ( ( V_b != c_Groups_Ozero__class_Ozero(T_a)
         => hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),c_Groups_Oplus__class_Oplus(T_a,V_a,V_b)),c_Rings_Oinverse__class_Oinverse(T_a,V_a))),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) = c_Groups_Oplus__class_Oplus(T_a,c_Rings_Oinverse__class_Oinverse(T_a,V_a),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) )
       <= c_Groups_Ozero__class_Ozero(T_a) != V_a )
     <= class_Fields_Ofield(T_a) ) ).
...
fof(fact_nonzero__minus__divide__divide,axiom,
    ! [V_a,V_b,T_a] :
      ( ( V_b != c_Groups_Ozero__class_Ozero(T_a)
       => c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b) = c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a),c_Groups_Ouminus__class_Ouminus(T_a,V_b)) )
     <= class_Rings_Odivision__ring(T_a) ) ).
...
fof(fact_mod__poly__eq,axiom,
    ! [V_r,V_q,V_y,V_x,T_a] :
      ( ( c_Polynomial_Opdivmod__rel(T_a,V_x,V_y,V_q,V_r)
       => V_r = c_Divides_Odiv__class_Omod(tc_Polynomial_Opoly(T_a),V_x,V_y) )
     <= class_Fields_Ofield(T_a) ) ).
...
fof(fact_dvd__iff__poly__eq__0,axiom,
    ! [V_pa_2,V_c_2,T_a] :
      ( class_Rings_Oidom(T_a)
     => ( c_Groups_Ozero__class_Ozero(T_a) = hAPP(c_Polynomial_Opoly(T_a,V_pa_2),c_Groups_Ouminus__class_Ouminus(T_a,V_c_2))
...
fof(fact_zmod__zminus2,axiom,
    ! [V_b,V_a] : c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,c_Divides_Odiv__class_Omod(tc_Int_Oint,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_a),V_b)) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_b)) ).

fof(fact_div__mult__mult1__if,axiom,
    ! [V_b,V_a,V_c,T_a] :
      ( ( ( V_c = c_Groups_Ozero__class_Ozero(T_a)
         => c_Groups_Ozero__class_Ozero(T_a) = c_Divides_Odiv__class_Odiv(T_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_a),hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_b)) )
        & ( V_c != c_Groups_Ozero__class_Ozero(T_a)
...
fof(fact_zmod__self,axiom,
    ! [V_a] : c_Groups_Ozero__class_Ozero(tc_Int_Oint) = c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_a) ).
...
fof(fact_zmod__zminus1__eq__if,axiom,
    ! [V_b,V_a] :
      ...
      & ( c_Divides_Odiv__class_Omod(tc_Int_Oint,V_a,V_b) = c_Groups_Ozero__class_Ozero(tc_Int_Oint)
       => c_Groups_Ozero__class_Ozero(tc_Int_Oint) = c_Divides_Odiv__class_Omod(tc_Int_Oint,c_Groups_Ouminus__class_Ouminus(tc_Int_Oint,V_a),V_b) ) ) ).
     ...
     => ( c_Rings_Odvd__class_Odvd(tc_Polynomial_Opoly(T_a),V_d,V_x)
       => ( ( ( ( ( hAPP(c_Polynomial_Ocoeff(T_a,V_d),c_Polynomial_Odegree(T_a,V_d)) = c_Groups_Ozero__class_Ozero(T_a)
                ...
                & ( hAPP(c_Polynomial_Ocoeff(T_a,V_d),c_Polynomial_Odegree(T_a,V_d)) = c_Groups_Oone__class_Oone(T_a)
                 <= ~ ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = V_y
                      & V_x = c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) ) ) )
             => V_d = c_Polynomial_Opoly__gcd(T_a,V_x,V_y) )
           <= ! [B_k] :
...
fof(fact_mod__Suc__eq__Suc__mod,axiom,
    ! [V_n,V_m] : c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(c_Divides_Odiv__class_Omod(tc_Nat_Onat,V_m,V_n)),V_n) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(V_m),V_n) ).
...
fof(fact_coeff__pCons,axiom,
    ! [V_pa_2,V_a_2,T_a] :
      ( class_Groups_Ozero(T_a)
     => c_Nat_Onat_Onat__case(T_a,V_a_2,c_Polynomial_Ocoeff(T_a,V_pa_2)) = c_Polynomial_Ocoeff(T_a,c_Polynomial_OpCons(T_a,V_a_2,V_pa_2)) ) ).
...
fof(fact_divide_Oadd,axiom,
    ! [V_ya,V_y,V_x,T_a] :
      ( class_RealVector_Oreal__normed__field(T_a)
     => c_Groups_Oplus__class_Oplus(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_x,V_ya),c_Rings_Oinverse__class_Odivide(T_a,V_y,V_ya)) = c_Rings_Oinverse__class_Odivide(T_a,c_Groups_Oplus__class_Oplus(T_a,V_x,V_y),V_ya) ) ).
...
fof(fact_mult__cancel2,axiom,
    ! [V_n_2,V_k_2,V_m_2] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_n_2),V_k_2) = hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_m_2),V_k_2)
    <=> ( V_m_2 = V_n_2
        | c_Groups_Ozero__class_Ozero(tc_Nat_Onat) = V_k_2 ) ) ).
...
fof(fact_nat__size,axiom,
    ! [V_n] : V_n = c_Nat_Osize__class_Osize(tc_Nat_Onat,V_n) ).
...
fof(fact_Suc__times__mod__eq,axiom,
    ! [V_m,V_k] :
      ( c_Groups_Oone__class_Oone(tc_Nat_Onat) = c_Divides_Odiv__class_Omod(tc_Nat_Onat,c_Nat_OSuc(hAPP(hAPP(c_Groups_Otimes__class_Otimes(tc_Nat_Onat),V_k),V_m)),V_k)
...
fof(fact_dvd__imp__mod__0,axiom,
    ! [V_b,V_a,T_a] :
      ( ( c_Rings_Odvd__class_Odvd(T_a,V_a,V_b)
       => c_Groups_Ozero__class_Ozero(T_a) = c_Divides_Odiv__class_Omod(T_a,V_b,V_a) )
     <= class_Divides_Osemiring__div(T_a) ) ).
...
fof(fact_nat_Osize_I4_J,axiom,
    ! [V_nat] : c_Groups_Oplus__class_Oplus(tc_Nat_Onat,c_Nat_Osize__class_Osize(tc_Nat_Onat,V_nat),c_Nat_OSuc(c_Groups_Ozero__class_Ozero(tc_Nat_Onat))) = c_Nat_Osize__class_Osize(tc_Nat_Onat,c_Nat_OSuc(V_nat)) ).
...
fof(fact_divide__inverse,axiom,
    ! [V_b,V_a,T_a] :
      ( hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_a),c_Rings_Oinverse__class_Oinverse(T_a,V_b)) = c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b)
     <= class_Rings_Odivision__ring(T_a) ) ).
...
fof(fact_nat__case__Suc,axiom,
    ! [V_nat_2,V_f2_2,V_f1_2,T_a] : hAPP(V_f2_2,V_nat_2) = hAPP(c_Nat_Onat_Onat__case(T_a,V_f1_2,V_f2_2),c_Nat_OSuc(V_nat_2)) ).
...
fof(fact_inverse__divide,axiom,
    ! [V_b,V_a,T_a] :
      ( c_Rings_Oinverse__class_Odivide(T_a,V_b,V_a) = c_Rings_Oinverse__class_Oinverse(T_a,c_Rings_Oinverse__class_Odivide(T_a,V_a,V_b))
     <= class_Fields_Ofield__inverse__zero(T_a) ) ).
...
fof(fact_pCons__eq__iff,axiom,
    ! [V_qa_2,V_b_2,V_pa_2,V_a_2,T_a] :
      ( ( c_Polynomial_OpCons(T_a,V_b_2,V_qa_2) = c_Polynomial_OpCons(T_a,V_a_2,V_pa_2)
      <=> ( V_b_2 = V_a_2
          & V_qa_2 = V_pa_2 ) )
     <= class_Groups_Ozero(T_a) ) ).
...
fof(fact_mod__minus__cong,axiom,
    ! [V_a_H,V_b,V_a,T_a] :
      ( class_Divides_Oring__div(T_a)
     => ( c_Divides_Odiv__class_Omod(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a_H),V_b) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Ouminus__class_Ouminus(T_a,V_a),V_b)
...
fof(fact_mod__mult__self1,axiom,
    ! [V_b,V_c,V_a,T_a] :
      ( class_Divides_Osemiring__div(T_a)
     => c_Divides_Odiv__class_Omod(T_a,V_a,V_b) = c_Divides_Odiv__class_Omod(T_a,c_Groups_Oplus__class_Oplus(T_a,V_a,hAPP(hAPP(c_Groups_Otimes__class_Otimes(T_a),V_c),V_b)),V_b) ) ).
...
fof(fact_synthetic__div__eq__0__iff,axiom,
    ! [V_c_2,V_pa_2,T_a] :
      ( ( c_Groups_Ozero__class_Ozero(tc_Polynomial_Opoly(T_a)) = c_Polynomial_Osynthetic__div(T_a,V_pa_2,V_c_2)
