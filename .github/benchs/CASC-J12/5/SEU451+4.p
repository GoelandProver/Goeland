...
fof(t35_relset_2,axiom,
    ! [A,B,C] :
     ...
     => ! [D] :
         ...
         => k3_tarski(a_4_3_relset_2(A,B,C,D)) = k9_relat_1(k5_setfam_1(k2_zfmisc_1(A,B),D),C) ) ) ).
...
fof(t65_relset_2,conjecture,
    ! [A,B,C] :
      ( m2_relset_1(C,A,B)
     => k9_relset_2(A,B,B,C,k6_partfun1(B)) = k9_relset_2(A,A,B,k6_partfun1(A),C) ) ).

fof(t51_relset_2,axiom,
    ! [A,B,C] :
      ( m2_relset_1(C,B,A)
     => ( k10_relset_1(B,A,C,B) = k2_funct_5(C)
...
fof(t59_relset_2,axiom,
    ! [A,B,C,D] :
     ...
     => ! [E] :
          ( m2_relset_1(E,A,B)
         => ! [F] :
              ( k8_relset_2(A,C,D,k3_subset_1(k2_zfmisc_1(A,C),k9_relset_2(A,B,C,E,k3_subset_1(k2_zfmisc_1(B,C),F)))) = k8_relset_2(B,C,k10_relset_1(A,B,E,D),F)
             <= m2_relset_1(F,B,C) ) ) ) ).
...
fof(t60_relset_2,axiom,
    ! [A,B,C] :
      ( k3_subset_1(k2_zfmisc_1(B,A),k6_relset_1(A,B,C)) = k4_relat_1(k3_subset_1(k2_zfmisc_1(A,B),C))
     <= m2_relset_1(C,A,B) ) ).
...
fof(t53_relset_2,axiom,
    ! [A,B,C,D] :
      ( ! [E] :
          ( ( k10_relset_1(B,C,E,k2_funct_5(D)) = k2_funct_5(k9_relset_2(A,B,C,D,E))
...
fof(t34_relset_2,axiom,
    ! [A,B,C] :
      ( ! [D] :
          ( ! [E] :
              ( m1_subset_1(E,k1_zfmisc_1(k2_zfmisc_1(A,B)))
             => k5_subset_1(B,k8_relset_2(A,B,C,D),k8_relset_2(A,B,C,E)) = k8_relset_2(A,B,C,k5_subset_1(k2_zfmisc_1(A,B),D,E)) )
         <= m1_subset_1(D,k1_zfmisc_1(k2_zfmisc_1(A,B))) )
     <= m1_subset_1(C,k1_zfmisc_1(A)) ) ).
...
fof(t56_relset_2,axiom,
    ! [A,B,C] :
     ...
     => ( k1_funct_5(C) = k10_relset_1(A,B,k6_relset_1(B,A,C),A)
        & k10_relset_1(A,B,k6_relset_1(B,A,C),k2_funct_5(C)) = k10_relset_1(A,B,k6_relset_1(B,A,C),k10_relset_1(B,A,C,B)) ) ) ).
...
fof(redefinition_k6_relset_2,axiom,
    ! [A,B,C] :
      ( k5_relset_2(B,C) = k6_relset_2(A,B,C)
     <= m1_subset_1(C,k1_zfmisc_1(k2_zfmisc_1(B,A))) ) ).

fof(t58_relset_2,axiom,
    ! [A,B,C] :
      ( k10_relset_1(B,B,k9_relset_2(B,A,B,k6_relset_1(A,B,C),C),B) = k10_relset_1(A,B,C,A)
     <= m2_relset_1(C,A,B) ) ).
