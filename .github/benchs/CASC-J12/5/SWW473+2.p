...
fof(help_COMBB_1_1_COMBB_000tc__Nat__Onat_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool__012,axiom,
    ! [P,Q,R] : hAPP_n1699378549t_bool(P,hAPP_f22106695ol_nat(Q,R)) = hAPP_f800510211t_bool(cOMBB_1250273980t_bool(P,Q),R) ).
...
fof(fact_494_subset__singletonD,axiom,
    ! [A_1,X_3] :
      ( ( bot_bot_fun_nat_bool = A_1
        | insert_nat(X_3,bot_bot_fun_nat_bool) = A_1 )
...
fof(conj_3,hypothesis,
    hAPP_nat_nat(minus_minus_nat(hAPP_fun_a_bool_nat(finite_card_a,image_pname_a(mgt_call,u))),hAPP_nat_nat(suc,na)) = hAPP_fun_a_bool_nat(finite_card_a,g) ).
...
fof(fact_342_insert__image,axiom,
    ! [F,X_3,A_1] :
     ...
     => image_nat_a(F,A_1) = insert_a(hAPP_nat_a(F,X_3),image_nat_a(F,A_1)) ) ).
...
fof(fact_257_insert__ident,axiom,
    ! [B_6,X_3,A_1] :
     ...
     => ( ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_3),B_6))
       => ( B_6 = A_1
        <=> insert_nat(X_3,B_6) = insert_nat(X_3,A_1) ) ) ) ).
...
fof(fact_336_image__insert,axiom,
    ! [F,A_3,B_6] : insert_a(hAPP_nat_a(F,A_3),image_nat_a(F,B_6)) = image_nat_a(F,insert_nat(A_3,B_6)) ).
...
fof(help_COMBC_1_1_COMBC_000t__a_000tc__fun_Itc__Com__Opname_Mtc__HOL__Obool_J_000tc,axiom,
    ! [P,Q,R] : hAPP_f1664156314l_bool(hAPP_a217006258l_bool(P,R),Q) = hAPP_a_bool(hAPP_f1051908748a_bool(cOMBC_1834145417l_bool(P),Q),R) ).
...
fof(help_COMBC_1_1_COMBC_000t__a_000tc__Nat__Onat_000tc__HOL__Obool_U,axiom,
    ! [P,Q,R] : hAPP_nat_bool(hAPP_a_fun_nat_bool(P,R),Q) = hAPP_a_bool(hAPP_nat_fun_a_bool(cOMBC_a_nat_bool(P),Q),R) ).

fof(fact_487_singleton__conv,axiom,
    ! [A_3] : insert_fun_a_bool(A_3,bot_bo1389914601l_bool) = collect_fun_a_bool(hAPP_f1631501043l_bool(cOMBC_1732670874l_bool(fequal_fun_a_bool),A_3)) ).
...
fof(fact_64_card__insert__if,axiom,
    ! [X_3,A_1] :
     ...
     => ( ( ~ hBOOL(hAPP_f1664156314l_bool(hAPP_p338031245l_bool(member_pname,X_3),A_1))
        ...
        & ( hBOOL(hAPP_f1664156314l_bool(hAPP_p338031245l_bool(member_pname,X_3),A_1))
         => hAPP_f921600141ol_nat(finite_card_pname,A_1) = hAPP_f921600141ol_nat(finite_card_pname,insert_pname(X_3,A_1)) ) ) ) ).
    ...
    ! [F,A_1,B_6] :
      ( ( hBOOL(hAPP_f1664156314l_bool(finite_finite_pname,B_6))
       => ( hBOOL(hAPP_f1664156314l_bool(hAPP_f434788991l_bool(ord_le313189616e_bool,B_6),image_1283814551_pname(F,A_1)))
         => ? [C_7] :
              ( is_fun1661590463l_bool(C_7)
              & image_1283814551_pname(F,C_7) = B_6
              & hBOOL(hAPP_f1935102916l_bool(finite595471783e_bool,C_7))
              & hBOOL(hAPP_f1935102916l_bool(hAPP_f510955609l_bool(ord_le675606854l_bool,C_7),A_1)) ) ) )
     <= is_fun_pname_bool(B_6) ) ).
...
fof(fact_472_Collect__conv__if,axiom,
    ! [Pa,A_3] :
      ( ( hBOOL(hAPP_a_bool(Pa,A_3))
       => insert_a(A_3,bot_bot_fun_a_bool) = collect_a(cOMBS_a_bool_bool(cOMBB_1972296269bool_a(fconj,hAPP_a_fun_a_bool(cOMBC_a_a_bool(fequal_a),A_3)),Pa)) )
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__Nat__Ona,axiom,
    ! [P,Q,R] : hAPP_nat_bool(hAPP_f800510211t_bool(P,R),Q) = hAPP_f54304608l_bool(hAPP_n215258509l_bool(cOMBC_385542954t_bool(P),Q),R) ).

fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__fun_Itc__021,axiom,
    ! [P,Q,R] : hAPP_f1637334154l_bool(hAPP_f1951378235l_bool(P,R),Q) = hAPP_f54304608l_bool(hAPP_f1246832597l_bool(cOMBC_1245412066l_bool(P),Q),R) ).
...
fof(help_COMBB_1_1_COMBB_000tc__Nat__Onat_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_,axiom,
    ! [P,Q,R] : hAPP_n1699378549t_bool(P,hAPP_a_nat(Q,R)) = hAPP_a_fun_nat_bool(cOMBB_1321347587bool_a(P,Q),R) ).
...
fof(fact_471_Collect__conv__if,axiom,
    ! [Pa,A_3] :
      ...
      & ( insert_pname(A_3,bot_bo844097828e_bool) = collect_pname(cOMBS_568398431l_bool(cOMBB_675860798_pname(fconj,hAPP_p61793385e_bool(cOMBC_1149511130e_bool(fequal_pname),A_3)),Pa))
       <= hBOOL(hAPP_pname_bool(Pa,A_3)) ) ) ).
...
fof(fact_341_insert__image,axiom,
    ! [F,X_3,A_1] :
      ( image_a_nat(F,A_1) = insert_nat(hAPP_a_nat(F,X_3),image_a_nat(F,A_1))
     <= hBOOL(hAPP_fun_a_bool_bool(hAPP_a85458249l_bool(member_a,X_3),A_1)) ) ).
     ...
     => ( hBOOL(hAPP_f1664156314l_bool(finite_finite_pname,B_6))
       => ( hBOOL(hAPP_f1664156314l_bool(hAPP_f434788991l_bool(ord_le313189616e_bool,B_6),image_1854862208_pname(F,A_1)))
         => ? [C_7] :
              ( hBOOL(hAPP_f621171935l_bool(hAPP_f1434722111l_bool(ord_le1375614389l_bool,C_7),A_1))
              & hBOOL(hAPP_f621171935l_bool(finite347923420a_bool,C_7))
              & image_1854862208_pname(F,C_7) = B_6
              & is_fun949378684l_bool(C_7) ) ) ) ) ).
...
fof(help_COMBC_1_1_COMBC_000tc__Com__Opname_000tc__fun_It__a_Mtc__HOL__Obool_J_000tc,axiom,
    ! [P,Q,R] : hAPP_fun_a_bool_bool(hAPP_p1824510254l_bool(P,R),Q) = hAPP_pname_bool(hAPP_f1794073134e_bool(cOMBC_445755039l_bool(P),Q),R) ).
...
fof(fact_243_insert__Collect,axiom,
    ! [A_3,Pa] : collect_nat(cOMBS_nat_bool_bool(cOMBB_1015721476ol_nat(fimplies,cOMBB_bool_bool_nat(fNot,hAPP_n1699378549t_bool(cOMBC_nat_nat_bool(fequal_nat),A_3))),Pa)) = insert_nat(A_3,collect_nat(Pa)) ).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_It__a_Mtc__HOL__Obool_J_000tc__fun_Itc__fun_It__,axiom,
    ! [P,Q,R] : hAPP_f621171935l_bool(hAPP_f285962445l_bool(P,R),Q) = hAPP_fun_a_bool_bool(hAPP_f2117159681l_bool(cOMBC_1880041174l_bool(P),Q),R) ).
...
fof(fact_343_insert__image,axiom,
    ! [F,X_3,A_1] :
      ( hBOOL(hAPP_f1664156314l_bool(hAPP_p338031245l_bool(member_pname,X_3),A_1))
     => image_pname_a(F,A_1) = insert_a(hAPP_pname_a(F,X_3),image_pname_a(F,A_1)) ) ).
...
fof(fact_167_finite__subset__image,axiom,
    ! [F,A_1,B_6] :
     ...
     => ( ? [C_7] :
            ( hBOOL(hAPP_f1637334154l_bool(finite2012431853t_bool,C_7))
            & image_496248727ol_nat(F,C_7) = B_6
            & hBOOL(hAPP_f1637334154l_bool(hAPP_f1772781669l_bool(ord_le1454342156l_bool,C_7),A_1)) )
       <= hBOOL(hAPP_f54304608l_bool(hAPP_f103356543l_bool(ord_le1568362934t_bool,B_6),image_496248727ol_nat(F,A_1))) ) ) ).
...
fof(help_COMBB_1_1_COMBB_000tc__Com__Opname_000tc__fun_Itc__Com__Opname_Mtc__HOL__Ob_017,axiom,
    ! [P,Q,R] : hAPP_p61793385e_bool(P,hAPP_f1297739591_pname(Q,R)) = hAPP_f759274231e_bool(cOMBB_598082538e_bool(P,Q),R) ).
...
fof(fact_420_empty__def,axiom,
    collect_fun_nat_bool(cOMBK_1994329625t_bool(fFalse)) = bot_bo1701429464l_bool ).
...
fof(fact_178_finite__subset__image,axiom,
    ! [F,A_1,B_6] :
     ...
     => ( hBOOL(hAPP_f621171935l_bool(finite347923420a_bool,B_6))
       => ( ? [C_7] :
              ( hBOOL(hAPP_f54304608l_bool(hAPP_f103356543l_bool(ord_le1568362934t_bool,C_7),A_1))
              & image_nat_fun_a_bool(F,C_7) = B_6
              & hBOOL(hAPP_f54304608l_bool(finite_finite_nat,C_7)) )
         <= hBOOL(hAPP_f621171935l_bool(hAPP_f1434722111l_bool(ord_le1375614389l_bool,B_6),image_nat_fun_a_bool(F,A_1))) ) ) ) ).
...
fof(fact_246_insert__absorb2,axiom,
    ! [X_3,A_1] : insert_nat(X_3,A_1) = insert_nat(X_3,insert_nat(X_3,A_1)) ).

fof(fact_353_imageE,axiom,
    ! [B_1,F,A_1] :
      ( ( ~ ! [X_1] :
              ( hAPP_nat_a(F,X_1) = B_1
             => ~ hBOOL(hAPP_f54304608l_bool(hAPP_n215258509l_bool(member_nat,X_1),A_1)) )
       <= hBOOL(hAPP_fun_a_bool_bool(hAPP_a85458249l_bool(member_a,B_1),image_nat_a(F,A_1))) )
     <= is_a(B_1) ) ).
...
fof(fact_474_Collect__conv__if,axiom,
    ! [Pa,A_3] :
      ( ( bot_bo1649642514l_bool = collec1974731493e_bool(cOMBS_350070575l_bool(cOMBB_2095475776e_bool(fconj,hAPP_f434788991l_bool(cOMBC_1284144636l_bool(fequal533582459e_bool),A_3)),Pa))
       <= ~ hBOOL(hAPP_f1664156314l_bool(Pa,A_3)) )
      & ( hBOOL(hAPP_f1664156314l_bool(Pa,A_3))
       => insert1325755072e_bool(A_3,bot_bo1649642514l_bool) = collec1974731493e_bool(cOMBS_350070575l_bool(cOMBB_2095475776e_bool(fconj,hAPP_f434788991l_bool(cOMBC_1284144636l_bool(fequal533582459e_bool),A_3)),Pa)) ) ) ).
...
fof(help_COMBB_1_1_COMBB_000tc__Com__Opname_000tc__fun_Itc__Com__Opname_Mtc__HOL__Ob,axiom,
    ! [P,Q,R] : hAPP_p61793385e_bool(P,hAPP_a_pname(Q,R)) = hAPP_a93125764e_bool(cOMBB_610033911bool_a(P,Q),R) ).
...
fof(help_COMBC_1_1_COMBC_000tc__Nat__Onat_000tc__fun_Itc__Com__Opname_Mtc__HOL__Oboo,axiom,
    ! [P,Q,R] : hAPP_f1664156314l_bool(hAPP_n850744903l_bool(P,R),Q) = hAPP_nat_bool(hAPP_f1066163005t_bool(cOMBC_386238098l_bool(P),Q),R) ).
...
fof(help_COMBC_1_1_COMBC_000t__a_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__,axiom,
    ! [P,Q,R] : hAPP_f54304608l_bool(hAPP_a1392362872l_bool(P,R),Q) = hAPP_a_bool(hAPP_f1549043526a_bool(cOMBC_777206479l_bool(P),Q),R) ).
...
fof(help_COMBC_1_1_COMBC_000tc__Com__Opname_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Oboo,axiom,
    ! [P,Q,R] : hAPP_f54304608l_bool(hAPP_p130839763l_bool(P,R),Q) = hAPP_pname_bool(hAPP_f654413245e_bool(cOMBC_267053842l_bool(P),Q),R) ).

fof(fact_65_card__insert__if,axiom,
    ! [X_3,A_1] :
      ( ( ( hBOOL(hAPP_fun_a_bool_bool(hAPP_a85458249l_bool(member_a,X_3),A_1))
         => hAPP_fun_a_bool_nat(finite_card_a,A_1) = hAPP_fun_a_bool_nat(finite_card_a,insert_a(X_3,A_1)) )
        & ( ~ hBOOL(hAPP_fun_a_bool_bool(hAPP_a85458249l_bool(member_a,X_3),A_1))
...
fof(fact_496_subset__singletonD,axiom,
    ! [A_1,X_3] :
      ( is_fun_a_bool(A_1)
     => ( ( insert_a(X_3,bot_bot_fun_a_bool) = A_1
          | A_1 = bot_bot_fun_a_bool )
...
fof(help_COMBB_1_1_COMBB_000tc__HOL__Obool_000tc__fun_Itc__HOL__Obool_Mtc__HOL__Oboo_010,axiom,
    ! [P,Q,R] : hAPP_b589554111l_bool(P,hAPP_fun_a_bool_bool(Q,R)) = hAPP_f198738859l_bool(cOMBB_338059395a_bool(P,Q),R) ).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool_J_000tc__fun_Itc_,axiom,
    ! [P,Q,R] : hAPP_f54304608l_bool(hAPP_f103356543l_bool(P,R),Q) = hAPP_f54304608l_bool(hAPP_f103356543l_bool(cOMBC_1693257480l_bool(P),Q),R) ).
...
fof(fact_237_insert__compr,axiom,
    ! [A_3,B_6] : collect_pname(cOMBS_568398431l_bool(cOMBB_675860798_pname(fdisj,hAPP_p61793385e_bool(cOMBC_1149511130e_bool(fequal_pname),A_3)),hAPP_f759274231e_bool(cOMBC_1058051404l_bool(member_pname),B_6))) = insert_pname(A_3,B_6) ).
...
fof(fact_653_card__Collect__less__nat,axiom,
    ! [Na] : Na = hAPP_f22106695ol_nat(finite_card_nat,collect_nat(hAPP_n1699378549t_bool(cOMBC_nat_nat_bool(ord_less_nat),Na))) ).
...
fof(fact_70_card__insert__disjoint,axiom,
    ! [X_3,A_1] :
      ( hBOOL(hAPP_f1664156314l_bool(finite_finite_pname,A_1))
     => ( ~ hBOOL(hAPP_f1664156314l_bool(hAPP_p338031245l_bool(member_pname,X_3),A_1))
       => hAPP_nat_nat(suc,hAPP_f921600141ol_nat(finite_card_pname,A_1)) = hAPP_f921600141ol_nat(finite_card_pname,insert_pname(X_3,A_1)) ) ) ).

fof(help_COMBB_1_1_COMBB_000t__a_000tc__fun_It__a_Mtc__HOL__Obool_J_000tc__Com__Opna,axiom,
    ! [P,Q,R] : hAPP_a_fun_a_bool(P,hAPP_pname_a(Q,R)) = hAPP_p1534023578a_bool(cOMBB_1897541054_pname(P,Q),R) ).
...
fof(fact_334_image__insert,axiom,
    ! [F,A_3,B_6] : insert_pname(hAPP_a_pname(F,A_3),image_a_pname(F,B_6)) = image_a_pname(F,insert_a(A_3,B_6)) ).
...
fof(fact_478_Collect__conv__if2,axiom,
    ! [Pa,A_3] :
      ( ( collect_a(cOMBS_a_bool_bool(cOMBB_1972296269bool_a(fconj,hAPP_a_fun_a_bool(fequal_a,A_3)),Pa)) = bot_bot_fun_a_bool
       <= ~ hBOOL(hAPP_a_bool(Pa,A_3)) )
      & ( hBOOL(hAPP_a_bool(Pa,A_3))
       => insert_a(A_3,bot_bot_fun_a_bool) = collect_a(cOMBS_a_bool_bool(cOMBB_1972296269bool_a(fconj,hAPP_a_fun_a_bool(fequal_a,A_3)),Pa)) ) ) ).
...
fof(fact_315_insert__compr__raw,axiom,
    ! [X_1,Xa] : collect_fun_a_bool(cOMBS_1035972772l_bool(cOMBB_338059395a_bool(fdisj,hAPP_f1631501043l_bool(cOMBC_1732670874l_bool(fequal_fun_a_bool),X_1)),hAPP_f2117159681l_bool(cOMBC_1880041174l_bool(member_fun_a_bool),Xa))) = insert_fun_a_bool(X_1,Xa) ).
...
fof(fact_335_image__insert,axiom,
    ! [F,A_3,B_6] : insert_nat(hAPP_a_nat(F,A_3),image_a_nat(F,B_6)) = image_a_nat(F,insert_a(A_3,B_6)) ).
...
fof(help_COMBB_1_1_COMBB_000tc__Nat__Onat_000tc__fun_Itc__Nat__Onat_Mtc__HOL__Obool__005,axiom,
    ! [P,Q,R] : hAPP_n1699378549t_bool(P,hAPP_pname_nat(Q,R)) = hAPP_p1499970991t_bool(cOMBB_523834888_pname(P,Q),R) ).
...
fof(fact_473_Collect__conv__if,axiom,
    ! [Pa,A_3] :
      ...
      & ( bot_bo1701429464l_bool = collect_fun_nat_bool(cOMBS_1187019125l_bool(cOMBB_444170502t_bool(fconj,hAPP_f103356543l_bool(cOMBC_1693257480l_bool(fequal_fun_nat_bool),A_3)),Pa))
       <= ~ hBOOL(hAPP_f54304608l_bool(Pa,A_3)) ) ) ).

fof(fact_480_Collect__conv__if2,axiom,
    ! [Pa,A_3] :
      ( ( ~ hBOOL(hAPP_f1664156314l_bool(Pa,A_3))
       => bot_bo1649642514l_bool = collec1974731493e_bool(cOMBS_350070575l_bool(cOMBB_2095475776e_bool(fconj,hAPP_f434788991l_bool(fequal533582459e_bool,A_3)),Pa)) )
...
fof(help_COMBC_1_1_COMBC_000tc__fun_Itc__Com__Opname_Mtc__HOL__Obool_J_000tc__Nat__O,axiom,
    ! [P,Q,R] : hAPP_nat_bool(hAPP_f1066163005t_bool(P,R),Q) = hAPP_f1664156314l_bool(hAPP_n850744903l_bool(cOMBC_1666426608t_bool(P),Q),R) ).
...
fof(fact_486_singleton__conv,axiom,
    ! [A_3] : insert1325755072e_bool(A_3,bot_bo1649642514l_bool) = collec1974731493e_bool(hAPP_f434788991l_bool(cOMBC_1284144636l_bool(fequal533582459e_bool),A_3)) ).
