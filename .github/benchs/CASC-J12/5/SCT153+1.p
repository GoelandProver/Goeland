...
fof(fact_folding__image__simple__idem_Oinsert__idem,axiom,
    ! [V_x_2,V_A_2,V_Fa_2,V_g_2,V_z_2,V_f_2,T_b,T_a] :
      ( ( hAPP(hAPP(V_f_2,hAPP(V_g_2,V_x_2)),hAPP(V_Fa_2,V_A_2)) = hAPP(V_Fa_2,c_Set_Oinsert(T_b,V_x_2,V_A_2))
...
fof(fact_folding_Ocommute__comp_H_H,axiom,
    ! [V_B_2,V_A_2,V_Fa_2,V_f_2,T_b,T_a] :
      ( ( ( c_Finite__Set_Ofinite(T_a,V_B_2)
         => c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_Fa_2,V_A_2),hAPP(V_Fa_2,V_B_2)) = c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_Fa_2,V_B_2),hAPP(V_Fa_2,V_A_2)) )
       <= c_Finite__Set_Ofinite(T_a,V_A_2) )
     <= c_Finite__Set_Ofolding(T_a,T_b,V_f_2,V_Fa_2) ) ).

fof(fact_rtrancl__idemp__self__comp,axiom,
    ! [V_R_2,T_a] : c_Transitive__Closure_Ortrancl(T_a,V_R_2) = c_Relation_Orel__comp(T_a,T_a,T_a,c_Transitive__Closure_Ortrancl(T_a,V_R_2),c_Transitive__Closure_Ortrancl(T_a,V_R_2)) ).
...
fof(fact_pair__leq__def,axiom,
    c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_prod(tc_Nat_Onat,tc_Nat_Onat)),tc_HOL_Obool),c_FunDef_Opair__less,c_Relation_OId(tc_prod(tc_Nat_Onat,tc_Nat_Onat))) = c_FunDef_Opair__leq ).
...
fof(fact_folding__idem_Oinsert__idem,axiom,
    ! [V_x_2,V_A_2,V_Fa_2,V_f_2,T_b,T_a] :
     ...
     => ( c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_Fa_2,V_A_2),hAPP(V_f_2,V_x_2)) = hAPP(V_Fa_2,c_Set_Oinsert(T_a,V_x_2,V_A_2))
       <= c_Finite__Set_Ofinite(T_a,V_A_2) ) ) ).
...
fof(fact_rtrancl__converse,axiom,
    ! [V_r_2,T_a] : hAPP(c_Relation_Oconverse(T_a,T_a),c_Transitive__Closure_Ortrancl(T_a,V_r_2)) = c_Transitive__Closure_Ortrancl(T_a,hAPP(c_Relation_Oconverse(T_a,T_a),V_r_2)) ).
...
fof(fact_converse__Id,axiom,
    ! [T_a] : c_Relation_OId(T_a) = hAPP(c_Relation_Oconverse(T_a,T_a),c_Relation_OId(T_a)) ).
...
fof(fact_folding__image__simple_Oempty,axiom,
    ! [V_Fa_2,V_g_2,V_z_2,V_f_2,T_b,T_a] :
      ( V_z_2 = hAPP(V_Fa_2,c_Orderings_Obot__class_Obot(tc_fun(T_b,tc_HOL_Obool)))
...
fof(fact_o__apply,axiom,
    ! [V_x_2,V_g_2,V_f_2,T_c,T_a,T_b] : hAPP(V_f_2,hAPP(V_g_2,V_x_2)) = hAPP(c_Fun_Ocomp(T_b,T_a,T_c,V_f_2,V_g_2),V_x_2) ).
...
fof(fact_smin__emptyI,axiom,
    ! [V_X_2] :
     ...
     <= c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)) != V_X_2 ) ).
...
fof(fact_R__O__Id,axiom,
    ! [V_R_2,T_b,T_a] : V_R_2 = c_Relation_Orel__comp(T_a,T_b,T_b,V_R_2,c_Relation_OId(T_b)) ).
...
fof(fact_Un__insert__left,axiom,
    ! [V_C_2,V_B_2,V_aa_2,T_a] : c_Set_Oinsert(T_a,V_aa_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_B_2,V_C_2)) = c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),c_Set_Oinsert(T_a,V_aa_2,V_B_2),V_C_2) ).
...
fof(fact_folding__image__simple__idem_Ounion__idem,axiom,
    ! [V_B_2,V_A_2,V_Fa_2,V_g_2,V_z_2,V_f_2,T_b,T_a] :
     ...
     => ( ( c_Finite__Set_Ofinite(T_b,V_B_2)
         => hAPP(hAPP(V_f_2,hAPP(V_Fa_2,V_A_2)),hAPP(V_Fa_2,V_B_2)) = hAPP(V_Fa_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_b,tc_HOL_Obool),V_A_2,V_B_2)) )
       <= c_Finite__Set_Ofinite(T_b,V_A_2) ) ) ).
...
fof(fact_trancl__unfold__right,axiom,
    ! [V_r_2,T_a] : c_Relation_Orel__comp(T_a,T_a,T_a,c_Transitive__Closure_Ortrancl(T_a,V_r_2),V_r_2) = c_Transitive__Closure_Otrancl(T_a,V_r_2) ).
...
fof(fact_converse__rel__comp,axiom,
    ! [V_s_2,V_r_2,T_c,T_a,T_b] : c_Relation_Orel__comp(T_a,T_c,T_b,hAPP(c_Relation_Oconverse(T_c,T_a),V_s_2),hAPP(c_Relation_Oconverse(T_b,T_c),V_r_2)) = hAPP(c_Relation_Oconverse(T_b,T_a),c_Relation_Orel__comp(T_b,T_c,T_a,V_r_2,V_s_2)) ).

fof(fact_wf__no__loop,axiom,
    ! [V_R_2,T_a] :
      ( c_Wellfounded_Owf(T_a,V_R_2)
     <= c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)) = c_Relation_Orel__comp(T_a,T_a,T_a,V_R_2,V_R_2) ) ).
...
fof(fact_folding_Ocommute__comp_H,axiom,
    ! [V_x_2,V_A_2,V_Fa_2,V_f_2,T_b,T_a] :
      ( ( c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_Fa_2,V_A_2),hAPP(V_f_2,V_x_2)) = c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_f_2,V_x_2),hAPP(V_Fa_2,V_A_2))
       <= c_Finite__Set_Ofinite(T_a,V_A_2) )
     <= c_Finite__Set_Ofolding(T_a,T_b,V_f_2,V_Fa_2) ) ).
...
fof(fact_trancl__converse,axiom,
    ! [V_r_2,T_a] : hAPP(c_Relation_Oconverse(T_a,T_a),c_Transitive__Closure_Otrancl(T_a,V_r_2)) = c_Transitive__Closure_Otrancl(T_a,hAPP(c_Relation_Oconverse(T_a,T_a),V_r_2)) ).
...
fof(fact_folding__image__simple__idem_Oidem,axiom,
    ! [V_x_2,V_Fa_2,V_g_2,V_z_2,V_f_2,T_b,T_a] :
      ( V_x_2 = hAPP(hAPP(V_f_2,V_x_2),V_x_2)
     <= c_Finite__Set_Ofolding__image__simple__idem(T_a,T_b,V_f_2,V_z_2,V_g_2,V_Fa_2) ) ).
...
fof(fact_o__eq__dest,axiom,
    ! [V_v_2,V_d_2,V_ca_2,T_d,V_ba_2,V_aa_2,T_a,T_b,T_c] :
      ( hAPP(V_ca_2,hAPP(V_d_2,V_v_2)) = hAPP(V_aa_2,hAPP(V_ba_2,V_v_2))
...
fof(fact_max__weak__def,axiom,
    c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),tc_HOL_Obool),c_Wellfounded_Omax__ext(tc_prod(tc_Nat_Onat,tc_Nat_Onat),c_FunDef_Opair__leq),c_Set_Oinsert(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),c_Product__Type_OPair(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool))),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),tc_HOL_Obool)))) = c_FunDef_Omax__weak ).
...
fof(fact_folding__idem_Ounion__idem,axiom,
    ! [V_B_2,V_A_2,V_Fa_2,V_f_2,T_b,T_a] :
     ...
     => ( c_Finite__Set_Ofinite(T_a,V_A_2)
       => ( c_Finite__Set_Ofinite(T_a,V_B_2)
         => c_Fun_Ocomp(T_b,T_b,T_b,hAPP(V_Fa_2,V_A_2),hAPP(V_Fa_2,V_B_2)) = hAPP(V_Fa_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(T_a,tc_HOL_Obool),V_A_2,V_B_2)) ) ) ) ).

fof(fact_folding_Ocommute__left__comp,axiom,
    ! [V_g_2,V_x_2,V_y_2,T_c,V_Fa_2,V_f_2,T_b,T_a] :
      ( c_Finite__Set_Ofolding(T_a,T_b,V_f_2,V_Fa_2)
     => c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_x_2),c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_y_2),V_g_2)) = c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_y_2),c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_x_2),V_g_2)) ) ).
...
fof(fact_folding__idem_Oidem__left__comp,axiom,
    ! [V_g_2,V_x_2,T_c,V_Fa_2,V_f_2,T_b,T_a] :
      ( c_Finite__Set_Ofolding__idem(T_a,T_b,V_f_2,V_Fa_2)
     => c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_x_2),V_g_2) = c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_x_2),c_Fun_Ocomp(T_b,T_b,T_c,hAPP(V_f_2,V_x_2),V_g_2)) ) ).
...
fof(fact_union__comp__emptyR,axiom,
    ! [V_C_2,V_B_2,V_A_2,T_a] :
     ...
     => ( c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)) = c_Relation_Orel__comp(T_a,T_a,T_a,V_A_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool),V_B_2,V_C_2))
       <= c_Orderings_Obot__class_Obot(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool)) = c_Relation_Orel__comp(T_a,T_a,T_a,V_A_2,V_C_2) ) ) ).
...
fof(fact_folding__image__simple__idem_Oin__idem,axiom,
    ! [V_x_2,V_A_2,V_Fa_2,V_g_2,V_z_2,V_f_2,T_b,T_a] :
      ( ( ( c_member(T_b,V_x_2,V_A_2)
         => hAPP(V_Fa_2,V_A_2) = hAPP(hAPP(V_f_2,hAPP(V_g_2,V_x_2)),hAPP(V_Fa_2,V_A_2)) )
       <= c_Finite__Set_Ofinite(T_b,V_A_2) )
     <= c_Finite__Set_Ofolding__image__simple__idem(T_a,T_b,V_f_2,V_z_2,V_g_2,V_Fa_2) ) ).
...
fof(fact_min__weak__def,axiom,
    c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),tc_HOL_Obool),c_Wellfounded_Omin__ext(tc_prod(tc_Nat_Onat,tc_Nat_Onat),c_FunDef_Opair__leq),c_Set_Oinsert(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),c_Product__Type_OPair(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool))),c_Orderings_Obot__class_Obot(tc_fun(tc_prod(tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool),tc_fun(tc_prod(tc_Nat_Onat,tc_Nat_Onat),tc_HOL_Obool)),tc_HOL_Obool)))) = c_FunDef_Omin__weak ).
...
fof(fact_Id__O__R,axiom,
    ! [V_R_2,T_b,T_a] : V_R_2 = c_Relation_Orel__comp(T_a,T_a,T_b,c_Relation_OId(T_a),V_R_2) ).
...
fof(fact_internal__split__conv,axiom,
    ! [V_ba_2,V_aa_2,V_ca_2,T_a,T_c,T_b] : hAPP(hAPP(V_ca_2,V_aa_2),V_ba_2) = c_Product__Type_Ointernal__split(T_b,T_c,T_a,V_ca_2,c_Product__Type_OPair(T_b,T_c,V_aa_2,V_ba_2)) ).
...
fof(fact_comp__cong,axiom,
    ! [T_e,T_d,T_c,T_a,T_b,V_x_H_2,V_g_H_2,V_f_H_2,V_x_2,V_g_2,V_f_2] :
     ...
     <= hAPP(V_f_H_2,hAPP(V_g_H_2,V_x_H_2)) = hAPP(V_f_2,hAPP(V_g_2,V_x_2)) ) ).
...
fof(fact_converse__inv__image,axiom,
    ! [V_f_2,V_R_2,T_b,T_a] : hAPP(c_Relation_Oinv__image(T_b,T_a,hAPP(c_Relation_Oconverse(T_b,T_b),V_R_2)),V_f_2) = hAPP(c_Relation_Oconverse(T_a,T_a),hAPP(c_Relation_Oinv__image(T_b,T_a,V_R_2),V_f_2)) ).
...
fof(fact_o__eq__elim,axiom,
    ! [V_d_2,V_ca_2,T_d,V_ba_2,V_aa_2,T_a,T_b,T_c] :
      ( ! [B_v] : hAPP(V_ca_2,hAPP(V_d_2,B_v)) = hAPP(V_aa_2,hAPP(V_ba_2,B_v))
     <= c_Fun_Ocomp(T_c,T_b,T_a,V_aa_2,V_ba_2) = c_Fun_Ocomp(T_d,T_b,T_a,V_ca_2,V_d_2) ) ).
...
fof(fact_cut__apply,axiom,
    ! [V_f_2,T_b,V_r_2,V_aa_2,V_x_2,T_a] :
      ( c_member(tc_prod(T_a,T_a),c_Product__Type_OPair(T_a,T_a,V_x_2,V_aa_2),V_r_2)
     => hAPP(V_f_2,V_x_2) = hAPP(c_Recdef_Ocut(T_a,T_b,V_f_2,V_r_2,V_aa_2),V_x_2) ) ).
...
fof(fact_Pair__eq,axiom,
    ! [V_b_H_2,V_a_H_2,V_ba_2,V_aa_2,T_b,T_a] :
      ( ( V_ba_2 = V_b_H_2
        & V_a_H_2 = V_aa_2 )
    <=> c_Product__Type_OPair(T_a,T_b,V_a_H_2,V_b_H_2) = c_Product__Type_OPair(T_a,T_b,V_aa_2,V_ba_2) ) ).
...
fof(fact_trancl__unfold,axiom,
    ! [V_r_2,T_a] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_a),tc_HOL_Obool),V_r_2,c_Relation_Orel__comp(T_a,T_a,T_a,c_Transitive__Closure_Otrancl(T_a,V_r_2),V_r_2)) = c_Transitive__Closure_Otrancl(T_a,V_r_2) ).
...
fof(fact_rel__comp__distrib,axiom,
    ! [V_T_2,V_S_2,V_R_2,T_b,T_c,T_a] : c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_a,T_b),tc_HOL_Obool),c_Relation_Orel__comp(T_a,T_c,T_b,V_R_2,V_S_2),c_Relation_Orel__comp(T_a,T_c,T_b,V_R_2,V_T_2)) = c_Relation_Orel__comp(T_a,T_c,T_b,V_R_2,c_Lattices_Osemilattice__sup__class_Osup(tc_fun(tc_prod(T_c,T_b),tc_HOL_Obool),V_S_2,V_T_2)) ).
