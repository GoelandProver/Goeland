...
fof(fact_202_insert__Collect,axiom,
    ! [A_1,Pa] : collec1974731493e_bool(cOMBS_350070575l_bool(cOMBB_2095475776e_bool(fimplies,cOMBB_307249310e_bool(fNot,hAPP_f434788991l_bool(cOMBC_1284144636l_bool(fequal533582459e_bool),A_1))),Pa)) = insert1325755072e_bool(A_1,collec1974731493e_bool(Pa)) ).
...
fof(fact_160_Suc__diff__diff,axiom,
    ! [M_2,N_1,K_1] : hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(M_2),N_1)),K_1) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(suc,M_2)),N_1)),hAPP_nat_nat(suc,K_1)) ).
...
fof(fact_103_card__insert__if,axiom,
    ! [X_2,A] :
      ( ( ( hAPP_nat_nat(suc,hAPP_fun_a_bool_nat(finite_card_a,A)) = hAPP_fun_a_bool_nat(finite_card_a,insert_a(X_2,A))
         <= ~ hBOOL(hAPP_fun_a_bool_bool(hAPP_a85458249l_bool(member_a,X_2),A)) )
...
fof(fact_209_insert__commute,axiom,
    ! [X_2,Y_1,A] : insert_a(Y_1,insert_a(X_2,A)) = insert_a(X_2,insert_a(Y_1,A)) ).
...
fof(fact_100_card__insert__if,axiom,
    ! [X_2,A] :
      ( hBOOL(hAPP_f621171935l_bool(finite347923420a_bool,A))
     => ( ( hBOOL(hAPP_f621171935l_bool(hAPP_f285962445l_bool(member_fun_a_bool,X_2),A))
         => hAPP_f2009550088ol_nat(finite1306199131a_bool,A) = hAPP_f2009550088ol_nat(finite1306199131a_bool,insert_fun_a_bool(X_2,A)) )
        & ( hAPP_f2009550088ol_nat(finite1306199131a_bool,insert_fun_a_bool(X_2,A)) = hAPP_nat_nat(suc,hAPP_f2009550088ol_nat(finite1306199131a_bool,A))
         <= ~ hBOOL(hAPP_f621171935l_bool(hAPP_f285962445l_bool(member_fun_a_bool,X_2),A)) ) ) ) ).
...
fof(fact_128_diff__commute,axiom,
    ! [I_1,J,K_1] : hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(I_1),K_1)),J) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(minus_minus_nat(I_1),J)),K_1) ).
...
fof(help_COMBC_1_1_COMBC_000tc__fun_It__a_Mtc__HOL__Obool_J_000tc__fun_It__a_Mtc__HO,axiom,
    ! [P,Q,R] : hAPP_fun_a_bool_bool(hAPP_f1631501043l_bool(P,R),Q) = hAPP_fun_a_bool_bool(hAPP_f1631501043l_bool(cOMBC_1732670874l_bool(P),Q),R) ).
...
fof(fact_164_eq__diff__iff,axiom,
    ! [Na,K,M_3] :
      ( ( ( hAPP_nat_nat(minus_minus_nat(Na),K) = hAPP_nat_nat(minus_minus_nat(M_3),K)
        <=> M_3 = Na )
       <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,K),Na)) )
     <= hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,K),M_3)) ) ).
...
fof(fact_116_Suc__diff__le,axiom,
    ! [N_1,M_2] :
      ( hBOOL(hAPP_nat_bool(hAPP_n1699378549t_bool(ord_less_eq_nat,N_1),M_2))
     => hAPP_nat_nat(suc,hAPP_nat_nat(minus_minus_nat(M_2),N_1)) = hAPP_nat_nat(minus_minus_nat(hAPP_nat_nat(suc,M_2)),N_1) ) ).

fof(fact_98_card__insert__if,axiom,
    ! [X_2,A] :
      ( hBOOL(hAPP_f1637334154l_bool(finite2012431853t_bool,A))
     => ( ( hBOOL(hAPP_f1637334154l_bool(hAPP_f1951378235l_bool(member_fun_nat_bool,X_2),A))
         => hAPP_f696928925ol_nat(finite346522414t_bool,A) = hAPP_f696928925ol_nat(finite346522414t_bool,insert_fun_nat_bool(X_2,A)) )
...
fof(fact_196_insert__compr,axiom,
    ! [A_1,B] : collec1974731493e_bool(cOMBS_350070575l_bool(cOMBB_2095475776e_bool(fdisj,hAPP_f434788991l_bool(cOMBC_1284144636l_bool(fequal533582459e_bool),A_1)),hAPP_f559147733l_bool(cOMBC_1988546018l_bool(member799430823e_bool),B))) = insert1325755072e_bool(A_1,B) ).
...
fof(fact_207_insert__commute,axiom,
    ! [X_2,Y_1,A] : insert_nat(Y_1,insert_nat(X_2,A)) = insert_nat(X_2,insert_nat(Y_1,A)) ).
