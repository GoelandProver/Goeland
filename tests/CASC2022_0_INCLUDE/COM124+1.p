%------------------------------------------------------------------------------
% File     : COM124+1 : TPTP v8.1.0. Released v6.4.0.
...
% Status   : Theorem
% Rating   : 0.86 v8.1.0, 0.81 v7.5.0, 0.78 v7.4.0, 0.73 v7.3.0, 0.83 v7.1.0, 0.74 v7.0.0, 0.87 v6.4.0
...
%------------------------------------------------------------------------------
% File     : COM001+1 : TPTP v8.1.0. Released v6.4.0.
% Domain   : Computing Theory
% Axioms   : Common axioms for progress/preservation proof
% Version  : [Gre15] axioms : Especial.
% English  :
