%------------------------------------------------------------------------------
% File     : CSR193+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated result relation 0308
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedResultRelation0308 [Alv18]
...
%            Number of connectives : 9474 ( 378   ~; 272   |;5285   &)
%                                         ( 709 <=>;2830  =>;   0  <=;   0 <~>)
...
%            Number of variables   : 6727 (5555   !;1172   ?)
% SPC      : FOF_CSA_RFO_SEQ
...
%------------------------------------------------------------------------------
fof(negatedResultRelation0308,conjecture,
    ! [X,Y] :
      ( ( p__d__instance(X,c__Process)
        & p__d__instance(Y,c__Object) )
     => ( ~ p__d__instance(X,c__SurfaceChange)
        | ~ p__attribute(Y,c__LineFormation)
        | ~ p__result(X,Y) ) ) ).
