%------------------------------------------------------------------------------
% File     : CSR175+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated antonym pattern 31742
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedAntonymPattern31742 [Alv18]
...
%            Number of connectives : 9471 ( 377   ~; 272   |;5284   &)
%                                         ( 709 <=>;2829  =>;   0  <=;   0 <~>)
...
%------------------------------------------------------------------------------
fof(negatedAntonymPattern31742,conjecture,
    ! [X,Y] :
      ( ~ p__d__instance(X,c__Collection)
      | ~ p__d__instance(Y,c__Separating)
      | X = Y ) ).
