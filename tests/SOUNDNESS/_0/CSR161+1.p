%------------------------------------------------------------------------------
% File     : CSR161+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Antonym pattern 20021
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : antonymPattern20021 [Alv18]
...
%------------------------------------------------------------------------------
fof(antonymPattern20021,conjecture,
    ? [Y] :
      ( p__d__instance(Y,c__Object)
      & ? [Z] :
          ( p__d__instance(Z,c__Attribute)
          & p__d__instance(Z,c__EmotionalState)
          & p__attribute(Y,Z) )
      & ! [X] :
          ( p__d__instance(X,c__Object)
         => ( p__attribute(X,c__Happiness)
           => Y != X ) ) ) ).
