%------------------------------------------------------------------------------
% File     : CSR173+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated agent relation 0781
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedAgentRelation0781 [Alv18]
...
%            Number of connectives : 9473 ( 377   ~; 271   |;5286   &)
%                                         ( 709 <=>;2830  =>;   0  <=;   0 <~>)
...
%------------------------------------------------------------------------------
fof(negatedAgentRelation0781,conjecture,
    ? [Y] :
