%------------------------------------------------------------------------------
% File     : CSR196+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated result relation 0494
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedResultRelation0494 [Alv18]
...
%------------------------------------------------------------------------------
fof(negatedResultRelation0494,conjecture,
    ? [Y] :
      ( p__d__instance(Y,c__ComputerProgram)
      & ! [X] :
          ( p__d__instance(X,c__Process)
         => ( ~ p__d__instance(X,c__Encoding)
            | ~ p__result(X,Y) ) ) ) ).
