%------------------------------------------------------------------------------
% File     : CSR165+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Antonym pattern 20398
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : antonymPattern20398 [Alv18]

% Status   : CounterSatisfiable
% Rating   : 1.00 v7.3.0
% Syntax   : Number of formulae    : 7433 (4642 unt;   0 def)
%            Number of atoms       : 16529 ( 373 equ)
%            Maximal formula atoms :   50 (   2 avg)
%            Number of connectives : 9472 ( 376   ~; 270   |;5286   &)
%                                         ( 709 <=>;2831  =>;   0  <=;   0 <~>)
...
%------------------------------------------------------------------------------
fof(antonymPattern20398,conjecture,
    ? [Y] :
      ( p__d__instance(Y,c__Object)
      & p__attribute(Y,c__White)
      & ! [X] :
          ( p__d__instance(X,c__Object)
         => ( p__attribute(X,c__Yellow)
           => Y != X ) ) ) ).
