%------------------------------------------------------------------------------
% File     : CSR171+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated agent relation 0337
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedAgentRelation0337 [Alv18]

% Status   : CounterSatisfiable
% Rating   : 1.00 v7.3.0
% Syntax   : Number of formulae    : 7433 (4642 unt;   0 def)
%            Number of atoms       : 16531 ( 372 equ)
%            Maximal formula atoms :   50 (   2 avg)
%            Number of connectives : 9477 ( 379   ~; 273   |;5285   &)
%                                         ( 709 <=>;2831  =>;   0  <=;   0 <~>)
...
%            Number of variables   : 6728 (5556   !;1172   ?)
% SPC      : FOF_CSA_RFO_SEQ
...
%------------------------------------------------------------------------------
fof(negatedAgentRelation0337,conjecture,
    ! [X,Y] :
      ( ( p__d__instance(X,c__Process)
        & p__d__instance(Y,c__Agent) )
     => ( ~ p__d__instance(X,c__Buying)
        | ! [Z] :
            ( p__d__instance(Z,c__Attribute)
           => ( ~ p__d__instance(Z,c__SocialRole)
              | ~ p__attribute(Y,Z) ) )
        | ~ p__agent(X,Y) ) ) ).
