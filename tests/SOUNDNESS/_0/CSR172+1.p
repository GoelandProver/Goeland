%------------------------------------------------------------------------------
% File     : CSR172+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated agent relation 0579
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedAgentRelation0579 [Alv18]
...
%------------------------------------------------------------------------------
fof(negatedAgentRelation0579,conjecture,
    ! [X,Y] :
      ( ( p__d__instance(X,c__Process)
        & p__d__instance(Y,c__Agent) )
     => ( ~ p__d__instance(X,c__Renting)
        | ! [Z] :
            ( p__d__instance(Z,c__Attribute)
           => ( ~ p__d__instance(Z,c__Position)
              | ~ p__attribute(Y,Z) ) )
        | ~ p__agent(X,Y) ) ) ).
