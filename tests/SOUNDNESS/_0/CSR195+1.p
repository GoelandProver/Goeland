%------------------------------------------------------------------------------
% File     : CSR195+1 : TPTP v8.1.2. Released v7.3.0.
% Domain   : Common Sense Reasoning
% Problem  : Negated result relation 0335
% Version  : Especial.
% English  :
...
% Source   : [Alv18]
% Names    : negatedResultRelation0335 [Alv18]
...
%------------------------------------------------------------------------------
fof(negatedResultRelation0335,conjecture,
    ? [Y] :
      ( p__d__instance(Y,c__Procedure)
      & ! [X] :
          ( p__d__instance(X,c__Process)
         => ( ~ p__d__instance(X,c__IntentionalPsychologicalProcess)
            | ~ p__result(X,Y) ) ) ) ).
