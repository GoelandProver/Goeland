%--------------------------------------------------------------------------
% File     : SET097+1 : TPTP v8.1.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.78 v7.5.0, 0.81 v7.4.0, 0.77 v7.3.0, 0.79 v7.1.0, 0.78 v7.0.0, 0.80 v6.4.0, 0.81 v6.3.0, 0.75 v6.2.0, 0.84 v6.1.0, 0.87 v5.5.0, 0.89 v5.4.0
...
%--------------------------------------------------------------------------
% File     : SET005+0 : TPTP v8.1.0. Bugfixed v5.4.0.
% Domain   : Set Theory
