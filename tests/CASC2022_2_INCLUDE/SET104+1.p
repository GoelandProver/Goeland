%--------------------------------------------------------------------------
% File     : SET104+1 : TPTP v8.1.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.97 v7.5.0, 1.00 v7.4.0, 0.90 v7.1.0, 0.87 v7.0.0, 0.93 v6.4.0, 0.88 v6.2.0, 0.96 v6.1.0, 1.00 v6.0.0, 0.96 v5.5.0, 1.00 v5.4.0
