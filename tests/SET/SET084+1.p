%--------------------------------------------------------------------------
% File     : SET084+1 : TPTP v7.4.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.28 v7.4.0, 0.17 v7.3.0, 0.24 v7.1.0, 0.13 v7.0.0, 0.17 v6.4.0, 0.27 v6.3.0, 0.33 v6.2.0, 0.44 v6.1.0, 0.40 v6.0.0, 0.43 v5.5.0, 0.37 v5.4.0
