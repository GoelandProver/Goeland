%--------------------------------------------------------------------------
% File     : SET634+3 : TPTP v7.4.0. Released v2.2.0.
% Domain   : Set Theory
% Problem  : X ^ (Y \ Z) = X ^ Y \ Z
