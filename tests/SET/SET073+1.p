%--------------------------------------------------------------------------
% File     : SET073+1 : TPTP v7.4.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.16 v7.4.0, 0.10 v7.1.0, 0.09 v7.0.0, 0.03 v6.4.0, 0.08 v6.3.0, 0.17 v6.2.0, 0.28 v6.1.0, 0.27 v6.0.0, 0.26 v5.4.0
