%--------------------------------------------------------------------------
% File     : SET024+1 : TPTP v7.4.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.12 v7.4.0, 0.07 v7.1.0, 0.04 v7.0.0, 0.07 v6.4.0, 0.08 v6.3.0, 0.12 v6.2.0, 0.24 v6.1.0, 0.20 v6.0.0, 0.13 v5.5.0, 0.07 v5.4.0
