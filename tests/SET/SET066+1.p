%------------------------------------------------------------------------------
% File     : SET066+1 : TPTP v7.4.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.81 v7.4.0, 0.77 v7.3.0, 0.76 v7.1.0, 0.74 v7.0.0, 0.77 v6.3.0, 0.79 v6.2.0, 0.88 v6.1.0, 0.87 v5.5.0, 0.85 v5.4.0
