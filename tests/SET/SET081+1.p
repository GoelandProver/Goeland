%--------------------------------------------------------------------------
% File     : SET081+1 : TPTP v7.4.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.22 v7.4.0, 0.17 v7.2.0, 0.14 v7.1.0, 0.09 v7.0.0, 0.10 v6.4.0, 0.12 v6.3.0, 0.17 v6.2.0, 0.24 v6.1.0, 0.20 v6.0.0, 0.22 v5.4.0
